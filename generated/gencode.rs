...
#[derive(Debug, Clone)]
pub struct opentype_layout_cursive_pos_entry_exit_records_exit_anchor {
offset: u16,
...
entry_anchor: opentype_layout_cursive_pos_entry_exit_records_exit_anchor,
exit_anchor: opentype_layout_cursive_pos_entry_exit_records_exit_anchor
}
...
#[derive(Debug, Clone)]
pub enum opentype_gpos_table_lookup_list_link_lookups_link_subtables_link { ChainedSequenceContext(opentype_common_chained_sequence_context), CursivePos(opentype_layout_cursive_pos), MarkBasePos, MarkLigPos, MarkMarkPos, PairPos(opentype_layout_pair_pos), PosExtension, SequenceContext(opentype_common_sequence_context), SinglePos(opentype_layout_single_pos) }
...
let r#where = ((|| PResult::Ok((Decoder76(_input))?))())?;
...
let gzip_raw = (Decoder282(_input))?;
let mut accum = Vec::new();
...
let eoi = ((|| PResult::Ok((Decoder204(_input))?))())?;
...
let signature = ((|| PResult::Ok((Decoder133(_input))?))())?;
...
let length = ((|| PResult::Ok((Decoder104(_input))?))())?;
let data = ((|| PResult::Ok({
...
tiff_main_byte_order::le(..) => {
let num_fields = ((|| PResult::Ok((Decoder116(_input))?))())?;
...
let length = ((|| PResult::Ok((Decoder104(_input))?))())?;
let offset_or_data = ((|| PResult::Ok((Decoder104(_input))?))())?;
tiff_main_ifd_fields { tag, r#type, length, offset_or_data }
});
}
accum
}))())?;
let next_ifd_offset = ((|| PResult::Ok((Decoder104(_input))?))())?;
...
let _is_advance = _input.advance_or_seek(tgt_offset)?;
let ret = ((|| PResult::Ok((Decoder91(_input, header.ident.data.clone() == 2u8, header.ident.class.clone(), header.phnum.clone()))?))())?;
_input.close_peek_context()?;
Some(ret)
} else {
None
...
let _is_advance = _input.advance_or_seek(tgt_offset)?;
let ret = ((|| PResult::Ok((Decoder92(_input, header.ident.data.clone() == 2u8, header.ident.class.clone(), header.shnum.clone()))?))())?;
_input.close_peek_context()?;
Some(ret)
} else {
None
...
let _is_advance = _input.advance_or_seek(tgt_offset)?;
let ret = ((|| PResult::Ok((Decoder93(_input, shdr.r#type.clone(), match shdr.size.clone() {
...
let created = ((|| PResult::Ok((Decoder75(_input))?))())?;
let modified = ((|| PResult::Ok((Decoder75(_input))?))())?;
...
let value_record = ((|| PResult::Ok((Decoder65(_input, table_start.clone(), value_format.clone()))?))())?;
...
accum.push((Decoder65(_input, table_start.clone(), value_format.clone()))?);
}
accum
}))())?;
...
Some((Decoder65(_input, table_start.clone(), value_format2.clone()))?)
} else {
None
}))())?;
...
accum.push({
let value_record1 = ((|| PResult::Ok(if value_format1.x_placement.clone() || value_format1.y_placement.clone() || value_format1.x_advance.clone() || value_format1.y_advance.clone() || value_format1.x_placement_device.clone() || value_format1.y_placement_device.clone() || value_format1.x_advance_device.clone() || value_format1.y_advance_device.clone() {
Some((Decoder66(_input, table_start.clone(), value_format1.clone()))?)
} else {
None
}))())?;
let value_record2 = ((|| PResult::Ok(if value_format2.x_placement.clone() || value_format2.y_placement.clone() || value_format2.x_advance.clone() || value_format2.y_advance.clone() || value_format2.x_placement_device.clone() || value_format2.y_placement_device.clone() || value_format2.x_advance_device.clone() || value_format2.y_advance_device.clone() {
Some((Decoder67(_input, table_start.clone(), value_format2.clone()))?)
} else {
None
}))())?;
...
fn Decoder65<'input>(_input: &mut Parser<'input>, table_start: u32, flags: opentype_common_value_format_flags) -> Result<opentype_common_value_record, ParseError> {
let x_placement = ((|| PResult::Ok(if flags.x_placement.clone() {
Some((Decoder23(_input))?)
} else {
None
...
fn Decoder66<'input>(_input: &mut Parser<'input>, table_start: u32, flags: opentype_common_value_format_flags) -> Result<opentype_common_value_record, ParseError> {
let x_placement = ((|| PResult::Ok(if flags.x_placement.clone() {
Some((Decoder23(_input))?)
} else {
None
...
fn Decoder67<'input>(_input: &mut Parser<'input>, table_start: u32, flags: opentype_common_value_format_flags) -> Result<opentype_common_value_record, ParseError> {
let x_placement = ((|| PResult::Ok(if flags.x_placement.clone() {
Some((Decoder23(_input))?)
} else {
None
...
fn Decoder75<'input>(_input: &mut Parser<'input>) -> Result<u64, ParseError> {
PResult::Ok((Decoder76(_input))?)
}

fn Decoder76<'input>(_input: &mut Parser<'input>) -> Result<u64, ParseError> {
let inner = {
let field0 = ((|| PResult::Ok((Decoder24(_input))?))())?;
let field1 = ((|| PResult::Ok((Decoder24(_input))?))())?;
let field2 = ((|| PResult::Ok((Decoder24(_input))?))())?;
...
13u16 => {
let inner = (Decoder86(_input, _platform.clone()))?;
...
fn Decoder86<'input>(_input: &mut Parser<'input>, _platform: u16) -> Result<opentype_cmap_subtable_format13, ParseError> {
let length = {
_input.open_peek_context();
let ret = ((|| PResult::Ok({
let _ = {
...
let r#type = ((|| PResult::Ok((Decoder112(_input, ident.data.clone() == 2u8))?))())?;
let machine = ((|| PResult::Ok((Decoder113(_input, ident.data.clone() == 2u8))?))())?;
let version = ((|| PResult::Ok((Decoder114(_input, ident.data.clone() == 2u8))?))())?;
...
let flags = ((|| PResult::Ok((Decoder95(_input, ident.data.clone() == 2u8))?))())?;
let ehsize = ((|| PResult::Ok((Decoder115(_input, ident.data.clone() == 2u8))?))())?;
let phentsize = ((|| PResult::Ok((Decoder115(_input, ident.data.clone() == 2u8))?))())?;
let phnum = ((|| PResult::Ok((Decoder115(_input, ident.data.clone() == 2u8))?))())?;
let shentsize = ((|| PResult::Ok((Decoder115(_input, ident.data.clone() == 2u8))?))())?;
let shnum = ((|| PResult::Ok((Decoder115(_input, ident.data.clone() == 2u8))?))())?;
let shstrndx = ((|| PResult::Ok((Decoder115(_input, ident.data.clone() == 2u8))?))())?;
...
fn Decoder91<'input>(_input: &mut Parser<'input>, is_be: bool, class: u8, phnum: u16) -> Result<Vec<elf_phdr_table>, ParseError> {
let mut accum = Vec::new();
for _ in 0..phnum {
...
fn Decoder92<'input>(_input: &mut Parser<'input>, is_be: bool, class: u8, shnum: u16) -> Result<Vec<elf_shdr_table>, ParseError> {
let mut accum = Vec::new();
for _ in 0..shnum {
...
fn Decoder93<'input>(_input: &mut Parser<'input>, r#type: u32, size: u64) -> Result<Vec<u8>, ParseError> {
...
let name = ((|| PResult::Ok((Decoder95(_input, is_be.clone()))?))())?;
let r#type = ((|| PResult::Ok((Decoder96(_input, is_be.clone()))?))())?;
...
let link = ((|| PResult::Ok((Decoder95(_input, is_be.clone()))?))())?;
let info = ((|| PResult::Ok((Decoder100(_input, is_be.clone()))?))())?;
...
fn Decoder95<'input>(_input: &mut Parser<'input>, is_be: bool) -> Result<u32, ParseError> {
...
fn Decoder96<'input>(_input: &mut Parser<'input>, is_be: bool) -> Result<u32, ParseError> {
...
PResult::Ok(match class {
1u8 => {
let inner = (Decoder101(_input, is_be.clone()))?;
elf_types_elf_off::Off32(inner)
},

2u8 => {
let inner = (Decoder102(_input, is_be.clone()))?;
...
PResult::Ok((Decoder95(_input, is_be.clone()))?)
}

fn Decoder101<'input>(_input: &mut Parser<'input>, is_be: bool) -> Result<u32, ParseError> {
let _ = _input.skip_align(4)?;
PResult::Ok(match is_be {
true => {
(Decoder20(_input))?
...
fn Decoder102<'input>(_input: &mut Parser<'input>, is_be: bool) -> Result<u64, ParseError> {
...
fn Decoder103<'input>(_input: &mut Parser<'input>) -> Result<u64, ParseError> {
let inner = {
let field0 = ((|| PResult::Ok((Decoder24(_input))?))())?;
let field1 = ((|| PResult::Ok((Decoder24(_input))?))())?;
let field2 = ((|| PResult::Ok((Decoder24(_input))?))())?;
...
fn Decoder104<'input>(_input: &mut Parser<'input>) -> Result<u32, ParseError> {
let inner = {
let field0 = ((|| PResult::Ok((Decoder24(_input))?))())?;
let field1 = ((|| PResult::Ok((Decoder24(_input))?))())?;
let field2 = ((|| PResult::Ok((Decoder24(_input))?))())?;
...
fn Decoder107<'input>(_input: &mut Parser<'input>, is_be: bool) -> Result<u64, ParseError> {
let _ = _input.skip_align(8)?;
PResult::Ok(match is_be {
true => {
(Decoder76(_input))?
...
let r#type = ((|| PResult::Ok((Decoder95(_input, is_be.clone()))?))())?;
let flags64 = ((|| PResult::Ok((Decoder109(_input, is_be.clone(), class.clone()))?))())?;
let offset = ((|| PResult::Ok((Decoder_elf_types_elf_off(_input, is_be.clone(), class.clone()))?))())?;
...
let flags32 = ((|| PResult::Ok((Decoder110(_input, is_be.clone(), class.clone()))?))())?;
...
fn Decoder109<'input>(_input: &mut Parser<'input>, is_be: bool, class: u8) -> Result<Option<u32>, ParseError> {
PResult::Ok(if class == 2u8 {
Some((Decoder95(_input, is_be.clone()))?)
} else {
None
})
}

fn Decoder110<'input>(_input: &mut Parser<'input>, is_be: bool, class: u8) -> Result<Option<u32>, ParseError> {
...
let class = ((|| PResult::Ok((Decoder117(_input))?))())?;
let data = ((|| PResult::Ok((Decoder118(_input))?))())?;
let version = ((|| PResult::Ok((Decoder119(_input))?))())?;
let os_abi = ((|| PResult::Ok((Decoder120(_input))?))())?;
let abi_version = ((|| PResult::Ok((Decoder121(_input))?))())?;
...
fn Decoder112<'input>(_input: &mut Parser<'input>, is_be: bool) -> Result<u16, ParseError> {
let inner = (Decoder115(_input, is_be.clone()))?;
...
fn Decoder113<'input>(_input: &mut Parser<'input>, is_be: bool) -> Result<u16, ParseError> {
PResult::Ok((Decoder115(_input, is_be.clone()))?)
}

fn Decoder114<'input>(_input: &mut Parser<'input>, is_be: bool) -> Result<u32, ParseError> {
let inner = (Decoder95(_input, is_be.clone()))?;
...
fn Decoder116<'input>(_input: &mut Parser<'input>) -> Result<u16, ParseError> {
let inner = {
let field0 = ((|| PResult::Ok((Decoder24(_input))?))())?;
let field1 = ((|| PResult::Ok((Decoder24(_input))?))())?;
(field0, field1)
...
let __nul_or_wsp = ((|| PResult::Ok((Decoder126(_input))?))())?;
let __padding = ((|| PResult::Ok({
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
...
let __nil = ((|| PResult::Ok((Decoder126(_input))?))())?;
...
let typeflag = ((|| PResult::Ok((Decoder127(_input))?))())?;
...
fn Decoder126<'input>(_input: &mut Parser<'input>) -> Result<u8, ParseError> {
let b = _input.read_byte()?;
...
fn Decoder127<'input>(_input: &mut Parser<'input>) -> Result<u8, ParseError> {
let b = _input.read_byte()?;
PResult::Ok(b)
}

fn Decoder128<'input>(_input: &mut Parser<'input>) -> Result<tar_ascii_string_opt0, ParseError> {
let string = ((|| PResult::Ok({
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
...
let field0 = ((|| PResult::Ok((Decoder127(_input))?))())?;
let field1 = ((|| PResult::Ok((Decoder127(_input))?))())?;
let field2 = ((|| PResult::Ok((Decoder127(_input))?))())?;
let field3 = ((|| PResult::Ok((Decoder127(_input))?))())?;
...
fn Decoder133<'input>(_input: &mut Parser<'input>) -> Result<(u8, u8, u8, u8, u8, u8, u8, u8), ParseError> {
let field0 = ((|| PResult::Ok({
let b = _input.read_byte()?;
if b == 137 {
b
...
let tag = ((|| PResult::Ok((Decoder180(_input))?))())?;
let data = ((|| PResult::Ok({
let sz = length as usize<>;
_input.start_slice(sz)?;
...
fn Decoder139<'input>(_input: &mut Parser<'input>) -> Result<(u8, u8, u8, u8), ParseError> {
let field0 = ((|| PResult::Ok({
let b = _input.read_byte()?;
if b == 73 {
b
...
fn Decoder140<'input>(_input: &mut Parser<'input>) -> Result<(), ParseError> {
PResult::Ok(())
}
...
fn Decoder148<'input>(_input: &mut Parser<'input>, extra_bits: u8, start: u16) -> Result<deflate_distance_record, ParseError> {
...
fn Decoder150<'input>(_input: &mut Parser<'input>) -> Result<Vec<u8>, ParseError> {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
_input.open_peek_context();
...
fn Decoder151<'input>(_input: &mut Parser<'input>) -> Result<u8, ParseError> {
let b = _input.read_byte()?;
...
fn Decoder152<'input>(_input: &mut Parser<'input>) -> Result<Vec<png_plte>, ParseError> {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
_input.open_peek_context();
...
let compressed_profile = ((|| PResult::Ok((Decoder179(_input))?))())?;
...
let inner = {
let field0 = ((|| PResult::Ok((Decoder173(_input))?))())?;
let field1 = ((|| PResult::Ok({
let b = _input.read_byte()?;
if b == 0 {
b
...
if matching_ix == 0 {
let next_elem = (Decoder127(_input))?;
accum.push(next_elem);
} else {
break
}
...
fn Decoder168<'input>(_input: &mut Parser<'input>) -> Result<Vec<u8>, ParseError> {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
_input.open_peek_context();
...
PResult::Ok((Decoder171(_input))?)
}

fn Decoder171<'input>(_input: &mut Parser<'input>) -> Result<Vec<char>, ParseError> {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
_input.open_peek_context();
...
fn Decoder173<'input>(_input: &mut Parser<'input>) -> Result<Vec<u8>, ParseError> {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
_input.open_peek_context();
...
fn Decoder176<'input>(_input: &mut Parser<'input>) -> Result<zlib_main, ParseError> {
let compression_method_flags = ((|| PResult::Ok({
let inner = {
let inner = {
let b = _input.read_byte()?;
...
fn Decoder177<'input>(_input: &mut Parser<'input>) -> Result<Vec<char>, ParseError> {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
_input.open_peek_context();
...
fn Decoder178<'input>(_input: &mut Parser<'input>) -> Result<Vec<u8>, ParseError> {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
_input.open_peek_context();
...
fn Decoder180<'input>(_input: &mut Parser<'input>) -> Result<(u8, u8, u8, u8), ParseError> {
let field0 = ((|| PResult::Ok({
let b = _input.read_byte()?;
if b == 73 {
b
...
let r#type = ((|| PResult::Ok((Decoder183(_input))?))())?;
...
let inner = {
let major_brand = ((|| PResult::Ok((Decoder183(_input))?))())?;
...
if matching_ix == 0 {
let next_elem = (Decoder183(_input))?;
accum.push(next_elem);
} else {
break
}
...
let handler_type = ((|| PResult::Ok((Decoder183(_input))?))())?;
...
let name = ((|| PResult::Ok((Decoder190(_input))?))())?;
...
1u8 => {
let inner = {
let creation_time = ((|| PResult::Ok((Decoder76(_input))?))())?;
let modification_time = ((|| PResult::Ok((Decoder76(_input))?))())?;
let timescale = ((|| PResult::Ok((Decoder20(_input))?))())?;
let duration = ((|| PResult::Ok((Decoder76(_input))?))())?;
...
let component_subtype = ((|| PResult::Ok((Decoder183(_input))?))())?;
...
let component_name = ((|| PResult::Ok((Decoder190(_input))?))())?;
...
let item_name = ((|| PResult::Ok((Decoder197(_input))?))())?;
let content_type = ((|| PResult::Ok((Decoder198(_input))?))())?;
let content_encoding = ((|| PResult::Ok((Decoder199(_input))?))())?;
...
let item_protection_index = ((|| PResult::Ok((Decoder23(_input))?))())?;
let item_type = ((|| PResult::Ok((Decoder183(_input))?))())?;
...
let inner = {
let item_uri_type = ((|| PResult::Ok((Decoder201(_input))?))())?;
...
fn Decoder197<'input>(_input: &mut Parser<'input>) -> Result<base_asciiz_string, ParseError> {
let string = ((|| PResult::Ok({
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
...
fn Decoder198<'input>(_input: &mut Parser<'input>) -> Result<base_asciiz_string, ParseError> {
let string = ((|| PResult::Ok({
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
...
fn Decoder199<'input>(_input: &mut Parser<'input>) -> Result<base_asciiz_string, ParseError> {
let string = ((|| PResult::Ok({
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
...
if matching_ix == 0 {
let next_elem = (Decoder211(_input))?;
accum.push(next_elem);
} else {
break
}
...
fn Decoder211<'input>(_input: &mut Parser<'input>) -> Result<jpeg_scan, ParseError> {
let segments = ((|| PResult::Ok({
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
...
fn Decoder214<'input>(_input: &mut Parser<'input>) -> Result<u8, ParseError> {
let tree_index = {
_input.open_peek_context();
let b = _input.read_byte()?;
{
...
fn Decoder216<'input>(_input: &mut Parser<'input>) -> Result<jpeg_eoi, ParseError> {
let ff = ((|| PResult::Ok({
let b = _input.read_byte()?;
if b == 255 {
b
...
fn Decoder217<'input>(_input: &mut Parser<'input>) -> Result<jpeg_eoi, ParseError> {
let ff = ((|| PResult::Ok({
let b = _input.read_byte()?;
if b == 255 {
b
...
fn Decoder226<'input>(_input: &mut Parser<'input>) -> Result<jpeg_scan_data, ParseError> {
let scan_data = ((|| PResult::Ok({
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
...
let identifier = ((|| PResult::Ok((Decoder266(_input))?))())?;
...
fn Decoder266<'input>(_input: &mut Parser<'input>) -> Result<base_asciiz_string, ParseError> {
let string = ((|| PResult::Ok({
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
...
let timestamp = ((|| PResult::Ok((Decoder104(_input))?))())?;
...
let xlen = ((|| PResult::Ok((Decoder116(_input))?))())?;
...
fn Decoder280<'input>(_input: &mut Parser<'input>) -> Result<base_asciiz_string, ParseError> {
let string = ((|| PResult::Ok({
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
...
let si1 = ((|| PResult::Ok((Decoder127(_input))?))())?;
let si2 = ((|| PResult::Ok((Decoder127(_input))?))())?;
let len = ((|| PResult::Ok((Decoder116(_input))?))())?;
let data = ((|| PResult::Ok({
let mut accum = Vec::new();
for _ in 0..len {
accum.push((Decoder24(_input))?);
...
fn Decoder282<'input>(_input: &mut Parser<'input>) -> Result<Vec<gzip_main>, ParseError> {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
_input.open_peek_context();
...
let fname = ((|| PResult::Ok(if header.file_flags.fname.clone() {
Some((Decoder283(_input))?)
} else {
None
}))())?;
let fcomment = ((|| PResult::Ok(if header.file_flags.fcomment.clone() {
Some((Decoder284(_input))?)
} else {
None
}))())?;
let fhcrc = ((|| PResult::Ok(if header.file_flags.fhcrc.clone() {
...
PResult::Ok((Decoder286(_input))?)
}

fn Decoder284<'input>(_input: &mut Parser<'input>) -> Result<gzip_fcomment, ParseError> {
let comment = ((|| PResult::Ok((Decoder285(_input))?))())?;
PResult::Ok(gzip_fcomment { comment })
}
...
let terminator = ((|| PResult::Ok((Decoder296(_input))?))())?;
...
fn Decoder296<'input>(_input: &mut Parser<'input>) -> Result<u8, ParseError> {
let b = _input.read_byte()?;
PResult::Ok(if b == 0 {
b
} else {
...
let delay_time = ((|| PResult::Ok((Decoder116(_input))?))())?;
...
let text_grid_left_position = ((|| PResult::Ok((Decoder116(_input))?))())?;
let text_grid_top_position = ((|| PResult::Ok((Decoder116(_input))?))())?;
let text_grid_width = ((|| PResult::Ok((Decoder116(_input))?))())?;
let text_grid_height = ((|| PResult::Ok((Decoder116(_input))?))())?;
...
let image_left_position = ((|| PResult::Ok((Decoder116(_input))?))())?;
let image_top_position = ((|| PResult::Ok((Decoder116(_input))?))())?;
let image_width = ((|| PResult::Ok((Decoder116(_input))?))())?;
let image_height = ((|| PResult::Ok((Decoder116(_input))?))())?;
let flags = ((|| PResult::Ok({
let inner = {
let b = _input.read_byte()?;
b
...
fn Decoder302<'input>(_input: &mut Parser<'input>) -> Result<png_plte, ParseError> {
let r = ((|| PResult::Ok((Decoder24(_input))?))())?;
let g = ((|| PResult::Ok((Decoder24(_input))?))())?;
let b = ((|| PResult::Ok((Decoder24(_input))?))())?;
PResult::Ok(png_plte { r, g, b })
...
let screen_width = ((|| PResult::Ok((Decoder116(_input))?))())?;
let screen_height = ((|| PResult::Ok((Decoder116(_input))?))())?;
let flags = ((|| PResult::Ok({
let inner = {
let b = _input.read_byte()?;
b
...
fn Decoder305<'input>(_input: &mut Parser<'input>) -> Result<u32, ParseError> {
let inner = {
let field0 = ((|| PResult::Ok({
let mut accum = Vec::new();
while _input.remaining() > 0 {
