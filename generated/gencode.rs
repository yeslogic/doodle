...
/// trait-orphaned: no decoder functions provided
#[derive(Debug, Copy, Clone)]
pub struct opentype_dsig_flags {
...
impl<'a> CommonObject for opentype_dsig<'a> {
type Args<'x> = ();

type Output<'x> = opentype_dsig<'x>;

fn parse<'input>(p: &mut Parser<'input>, _: ()) -> Result<Self::Output<'input>, ParseError> {
Decoder_opentype_dsig(p)
}
}
...
#[derive(Debug, Clone)]
pub struct opentype_dsig<'input> {
table_scope: View<'input>,
version: u32,
num_signatures: u16,
flags: opentype_dsig_flags,
...
impl<'a> CommonObject for opentype_hdmx<'a> {
type Args<'x> = u16;

type Output<'x> = opentype_hdmx<'x>;

fn parse<'input>(p: &mut Parser<'input>, num_glyphs: Self::Args<'input>) -> Result<Self::Output<'input>, ParseError> {
Decoder_opentype_hdmx(p, num_glyphs)
}
}
...
#[derive(Debug, Clone)]
pub struct opentype_hdmx<'input> {
version: u16,
num_records: u16,
...
/// trait-orphaned: no decoder functions provided
#[derive(Debug, Copy, Clone)]
pub struct opentype_vdmx_ratio_range {
b_char_set: u8,
x_ratio: u8,
y_start_ratio: u8,
y_end_ratio: u8
...
/// trait-orphaned: no decoder functions provided
#[derive(Debug, Copy, Clone)]
pub struct opentype_vdmx_vdmx_group_offsets {
offset: u16,
_data: std::marker::PhantomData<Option<opentype_vdmx_group>>
}

impl<'a> CommonObject for opentype_vdmx<'a> {
type Args<'x> = ();

type Output<'x> = opentype_vdmx<'x>;

fn parse<'input>(p: &mut Parser<'input>, _: ()) -> Result<Self::Output<'input>, ParseError> {
Decoder_opentype_vdmx(p)
}
}
...
#[derive(Debug, Clone)]
pub struct opentype_vdmx<'input> {
table_scope: View<'input>,
version: u16,
num_recs: u16,
num_ratios: u16,
ratio_range: Vec<opentype_vdmx_ratio_range>,
vdmx_group_offsets: Vec<opentype_vdmx_vdmx_group_offsets>
}
...
dsig: Option<opentype_dsig<'input>>,
hdmx: Option<opentype_hdmx<'input>>,
vdmx: Option<opentype_vdmx<'input>>
}
...
let sz = table.length as usize;
view_input.start_slice(sz)?;
let ret = (Decoder_opentype_hdmx(view_input, maxp.num_glyphs))?;
view_input.end_slice()?;
Some(ret)
},
...
let sz = table.length as usize;
view_input.start_slice(sz)?;
let ret = (Decoder_opentype_vdmx(view_input))?;
view_input.end_slice()?;
Some(ret)
},
...
/// d#53
fn Decoder_opentype_dsig<'input>(_input: &mut Parser<'input>) -> Result<opentype_dsig<'input>, ParseError> {
let table_view = _input.view();
let table_scope = table_view;
let version = {
let inner = {
...
opentype_dsig_flags { cannot_be_resigned }
};
...
PResult::Ok(opentype_dsig { table_scope, version, num_signatures, flags, signature_records })
}

/// d#54
fn Decoder_opentype_hdmx<'input>(_input: &mut Parser<'input>, num_glyphs: u16) -> Result<opentype_hdmx<'input>, ParseError> {
let version = {
let inner = {
let x = (_input.read_byte()?, _input.read_byte()?);
u16be(x)
...
PResult::Ok(opentype_hdmx { version, num_records, size_device_record, records })
}

/// d#55
fn Decoder_opentype_vdmx<'input>(_input: &mut Parser<'input>) -> Result<opentype_vdmx<'input>, ParseError> {
let table_view = _input.view();
let table_scope = table_view;
let version = {
let inner = {
...
opentype_vdmx_ratio_range { b_char_set, x_ratio, y_start_ratio, y_end_ratio }
};
accum.push(next_elem)
};
accum
...
let _data = std::marker::PhantomData;
opentype_vdmx_vdmx_group_offsets { offset, _data }
};
accum.push(next_elem)
};
accum
};
PResult::Ok(opentype_vdmx { table_scope, version, num_recs, num_ratios, ratio_range, vdmx_group_offsets })
}
...
return Err(ParseError::FalsifiedWhere(757122060916971772u64));
}
};
...
return Err(ParseError::FalsifiedWhere(5986772336072340665u64));
}
};
...
30u8..=31u8 => {
return Err(ParseError::FailToken(1587806253186841834u64));
},
...
return Err(ParseError::FalsifiedWhere(11733915986279978987u64));
}
};
let flags = {
let _packed_bits = _input.read_byte()?;
...
return Err(ParseError::FalsifiedWhere(6768457941542394460u64));
}
};
let flags = {
let _packed_bits = _input.read_byte()?;
...
return Err(ParseError::FalsifiedWhere(7474037925185307628u64));
}
};
let flags = {
let _packed_bits = _input.read_byte()?;
...
return Err(ParseError::FalsifiedWhere(3448575031819686448u64));
}
};
...
return Err(ParseError::FalsifiedWhere(787921071240225899u64));
}
};
let density_x = {
let inner = {
...
return Err(ParseError::FalsifiedWhere(11557974043504662535u64));
}
};
let density_y = {
let inner = {
