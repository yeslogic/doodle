...
#[derive(Debug, Clone)]
pub struct opentype_gsub_table_lookup_list_link_lookups_link_subtables_link_LigatureSubst_ligature_sets_link_ligatures_link {
ligature_glyph: u16,
component_count: u16,
...
#[derive(Debug, Clone)]
pub struct opentype_gsub_table_lookup_list_link_lookups_link_subtables_link_LigatureSubst_ligature_sets_link_ligatures {
offset: u16,
link: Option<opentype_gsub_table_lookup_list_link_lookups_link_subtables_link_LigatureSubst_ligature_sets_link_ligatures_link>
}

#[derive(Debug, Clone)]
pub struct opentype_gsub_table_lookup_list_link_lookups_link_subtables_link_LigatureSubst_ligature_sets_link {
table_start: u32,
ligature_count: u16,
ligatures: Vec<opentype_gsub_table_lookup_list_link_lookups_link_subtables_link_LigatureSubst_ligature_sets_link_ligatures>
}

#[derive(Debug, Clone)]
pub struct opentype_gsub_table_lookup_list_link_lookups_link_subtables_link_LigatureSubst_ligature_sets {
offset: u16,
link: Option<opentype_gsub_table_lookup_list_link_lookups_link_subtables_link_LigatureSubst_ligature_sets_link>
}

#[derive(Debug, Clone)]
pub struct opentype_gsub_table_lookup_list_link_lookups_link_subtables_link_LigatureSubst {
table_start: u32,
subst_format: u16,
coverage: opentype_common_chained_sequence_context_subst_Format1_coverage,
ligature_set_count: u16,
ligature_sets: Vec<opentype_gsub_table_lookup_list_link_lookups_link_subtables_link_LigatureSubst_ligature_sets>
}
...
opentype_gsub_table_lookup_list_link_lookups_link_subtables_link_LigatureSubst_ligature_sets_link_ligatures_link { ligature_glyph, component_count, component_glyph_ids }
}))())?;
_input.close_peek_context()?;
Some(ret)
} else {
...
opentype_gsub_table_lookup_list_link_lookups_link_subtables_link_LigatureSubst_ligature_sets_link_ligatures { offset, link }
});
}
accum
}))())?;
opentype_gsub_table_lookup_list_link_lookups_link_subtables_link_LigatureSubst_ligature_sets_link { table_start, ligature_count, ligatures }
}))())?;
_input.close_peek_context()?;
Some(ret)
} else {
...
opentype_gsub_table_lookup_list_link_lookups_link_subtables_link_LigatureSubst_ligature_sets { offset, link }
});
}
accum
}))())?;
opentype_gsub_table_lookup_list_link_lookups_link_subtables_link_LigatureSubst { table_start, subst_format, coverage, ligature_set_count, ligature_sets }
};
opentype_gsub_table_lookup_list_link_lookups_link_subtables_link::LigatureSubst(inner)
},
