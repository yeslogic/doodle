...
/// expected size: 3
/// trait-unready: multiple (2) decoders exist (d#{427, 462})
#[derive(Debug, Copy, Clone)]
...
/// expected size: 24
/// trait-unready: multiple (2) decoders exist (d#{438, 446})
#[derive(Debug, Clone)]
...
/// expected size: 4
/// trait-unready: multiple (2) decoders exist (d#{265, 266})
#[derive(Debug, Copy, Clone)]
...
/// expected size: 1
/// trait-unready: multiple (10) decoders exist (d#{357, 359, 370, 371, 372, 373, 374, 375, 376, 377})
#[derive(Debug, Copy, Clone)]
pub struct jpeg_soi {
marker: u8
}
...
/// expected size: 56
/// trait-unready: multiple (3) decoders exist (d#{247, 248, 249})
#[derive(Debug, Clone)]
...
/// expected size: 32
/// trait-unready: multiple (16) decoders exist (d#{405, 406, 407, 408, 409, 410, 411, 412, 413, 414, 415, 416, 417, 418, 419, 475})
#[derive(Debug, Clone)]
...
/// expected size: 2
/// trait-unready: multiple (2) decoders exist (d#{469, 471})
#[derive(Debug, Copy, Clone)]
...
/// expected size: 4
/// trait-unready: multiple (3) decoders exist (d#{398, 470, 473})
#[derive(Debug, Copy, Clone)]
...
/// expected size: 32
/// trait-unready: multiple (3) decoders exist (d#{397, 472, 477})
#[derive(Debug, Clone)]
...
/// expected size: 40
/// trait-unready: multiple (14) decoders exist (d#{384, 385, 386, 387, 388, 389, 390, 391, 392, 393, 394, 395, 396, 476})
#[derive(Debug, Clone)]
...
/// expected size: 48
/// trait-unready: multiple (2) decoders exist (d#{367, 383})
#[derive(Debug, Clone)]
...
/// expected size: 112
/// trait-unready: multiple (2) decoders exist (d#{363, 365})
#[derive(Debug, Clone)]
...
/// expected size: 40
/// trait-unready: multiple (2) decoders exist (d#{332, 334})
#[derive(Debug, Clone)]
...
/// expected size: 40
/// trait-unready: multiple (2) decoders exist (d#{206, 207})
#[derive(Debug, Clone)]
...
/// expected size: 32
/// trait-unready: multiple (6) decoders exist (d#{160, 161, 164, 165, 168, 169})
#[derive(Debug, Copy, Clone)]
...
/// expected size: 96
/// trait-unready: multiple (4) decoders exist (d#{256, 287, 293, 298})
#[derive(Debug, Clone)]
...
/// expected size: 24
/// trait-unready: multiple (3) decoders exist (d#{242, 244, 245})
#[derive(Debug, Clone)]
...
/// expected size: 24
/// trait-unready: multiple (2) decoders exist (d#{12, 444})
#[derive(Debug, Clone)]
pub struct tar_main {
...
/// expected size: 2
/// trait-unready: multiple (2) decoders exist (d#{474, 479})
#[derive(Debug, Copy, Clone)]
...
let next_elem = (Decoder468(_input))?;
accum.push(next_elem)
}
};
PResult::Ok(accum)
...
let _is_advance = _input.advance_or_seek(tgt_offset)?;
let ret = (Decoder212(_input, header.ident.data == 2u8, header.ident.class, header.phnum))?;
_input.close_peek_context()?;
Some(ret)
} else {
None
...
let _is_advance = _input.advance_or_seek(tgt_offset)?;
let ret = (Decoder213(_input, header.ident.data == 2u8, header.ident.class, header.shnum))?;
_input.close_peek_context()?;
Some(ret)
} else {
None
...
let _is_advance = _input.advance_or_seek(tgt_offset)?;
let ret = (Decoder214(_input, shdr.r#type, match shdr.size {
...
let created = (Decoder197(_input))?;
let modified = (Decoder197(_input))?;
let glyph_extents = {
let x_min = {
let raw = {
let x = (_input.read_byte()?, _input.read_byte()?);
...
PResult::Ok(opentype_mvar_table { table_scope, major_version, minor_version, value_record_size, value_record_count })
}
...
/// d#81
fn Decoder81(_input: &mut Parser<'_>) -> Result<(u16, Vec<opentype_var_packed_point_numbers_runs>), ParseError> {
let tree_index = {
_input.open_peek_context();
{
let ret = match _input.read_byte()? {
...
(Decoder82(_input, point_count as u16))?
},
...
(Decoder82(_input, ((hi as u16) & 127u16) << 8u16 | (lo as u16)))?
},
...
/// d#82
fn Decoder82(_input: &mut Parser<'_>, point_count: u16) -> Result<(u16, Vec<opentype_var_packed_point_numbers_runs>), ParseError> {
...
Some((Decoder161(_input, value_format2, table_view))?)
} else {
None
};
...
/// d#161
fn Decoder161<'input>(_input: &mut Parser<'input>, flags: opentype_layout_value_format_flags, table_view: View<'input>) -> Result<opentype_layout_value_record, ParseError> {
let x_placement = if flags.x_placement {
let raw = {
let x = (_input.read_byte()?, _input.read_byte()?);
u16be(x)
...
let value_record1 = if value_format1.x_placement || value_format1.y_placement || value_format1.x_advance || value_format1.y_advance || value_format1.x_placement_device || value_format1.y_placement_device || value_format1.x_advance_device || value_format1.y_advance_device {
Some((Decoder164(_input, value_format1, set_view))?)
} else {
None
};
let value_record2 = if value_format2.x_placement || value_format2.y_placement || value_format2.x_advance || value_format2.y_advance || value_format2.x_placement_device || value_format2.y_placement_device || value_format2.x_advance_device || value_format2.y_advance_device {
Some((Decoder165(_input, value_format2, set_view))?)
} else {
None
};
...
/// d#164
fn Decoder164<'input>(_input: &mut Parser<'input>, flags: opentype_layout_value_format_flags, table_view: View<'input>) -> Result<opentype_layout_value_record, ParseError> {
let x_placement = if flags.x_placement {
let raw = {
let x = (_input.read_byte()?, _input.read_byte()?);
u16be(x)
...
let value_record = (Decoder169(_input, value_format, table_view))?;
...
let next_elem = (Decoder168(_input, value_format, table_view))?;
accum.push(next_elem)
};
accum
};
...
/// d#197
fn Decoder197(_input: &mut Parser<'_>) -> Result<i64, ParseError> {
let raw = {
let x = (_input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?);
u64be(x)
};
...
13u16 => {
let inner = (Decoder207(_input, _platform))?;
...
/// d#207
fn Decoder207(_input: &mut Parser<'_>, _platform: u16) -> Result<opentype_cmap_subtable_format12, ParseError> {
let length = {
_input.open_peek_context();
let ret = ((|| {
let _format = {
...
let r#type = (Decoder231(_input, ident.data == 2u8))?;
let machine = (Decoder232(_input, ident.data == 2u8))?;
let version = (Decoder233(_input, ident.data == 2u8))?;
...
let flags = (Decoder216(_input, ident.data == 2u8))?;
let ehsize = (Decoder234(_input, ident.data == 2u8))?;
let phentsize = (Decoder234(_input, ident.data == 2u8))?;
let phnum = (Decoder234(_input, ident.data == 2u8))?;
let shentsize = (Decoder234(_input, ident.data == 2u8))?;
let shnum = (Decoder234(_input, ident.data == 2u8))?;
let shstrndx = (Decoder234(_input, ident.data == 2u8))?;
...
/// d#212
fn Decoder212(_input: &mut Parser<'_>, is_be: bool, class: u8, phnum: u16) -> Result<Vec<elf_phdr>, ParseError> {
let mut accum = Vec::new();
for _ in 0..phnum {
...
/// d#213
fn Decoder213(_input: &mut Parser<'_>, is_be: bool, class: u8, shnum: u16) -> Result<Vec<elf_shdr>, ParseError> {
let mut accum = Vec::new();
for _ in 0..shnum {
...
/// d#214
fn Decoder214(_input: &mut Parser<'_>, r#type: u32, size: u64) -> Result<Vec<u8>, ParseError> {
PResult::Ok({
let _ = r#type;
let mut accum = Vec::new();
for _ in 0..size {
...
let name = (Decoder216(_input, is_be))?;
...
let link = (Decoder216(_input, is_be))?;
let info = (Decoder221(_input, is_be))?;
...
/// d#216
fn Decoder216(_input: &mut Parser<'_>, is_be: bool) -> Result<u32, ParseError> {
_input.skip_align(4)?;
...
PResult::Ok(match class {
1u8 => {
let inner = (Decoder222(_input, is_be))?;
...
/// d#223
fn Decoder223(_input: &mut Parser<'_>, is_be: bool) -> Result<u64, ParseError> {
_input.skip_align(8)?;
PResult::Ok(match is_be {
true => {
let x = (_input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?);
...
/// d#224
fn Decoder224(_input: &mut Parser<'_>, is_be: bool) -> Result<u32, ParseError> {
_input.skip_align(4)?;
PResult::Ok(match is_be {
true => {
let x = (_input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?);
...
/// d#225
fn Decoder225(_input: &mut Parser<'_>, is_be: bool) -> Result<u64, ParseError> {
_input.skip_align(8)?;
PResult::Ok(match is_be {
true => {
let x = (_input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?);
...
let r#type = (Decoder216(_input, is_be))?;
let flags64 = (Decoder228(_input, is_be, class))?;
let offset = (Decoder_elf_types_elf_off(_input, is_be, class))?;
...
let flags32 = (Decoder229(_input, is_be, class))?;
...
/// d#228
fn Decoder228(_input: &mut Parser<'_>, is_be: bool, class: u8) -> Result<Option<u32>, ParseError> {
PResult::Ok(if class == 2u8 {
Some((Decoder216(_input, is_be))?)
} else {
None
})
}
...
let class = (Decoder235(_input))?;
let data = (Decoder236(_input))?;
let version = (Decoder237(_input))?;
let os_abi = (Decoder238(_input))?;
let abi_version = (Decoder239(_input))?;
{
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
...
/// d#231
fn Decoder231(_input: &mut Parser<'_>, is_be: bool) -> Result<u16, ParseError> {
let inner = (Decoder234(_input, is_be))?;
let is_valid = {
let r#type = inner;
...
Decoder234(_input, is_be)
}

/// d#233
fn Decoder233(_input: &mut Parser<'_>, is_be: bool) -> Result<u32, ParseError> {
let inner = (Decoder216(_input, is_be))?;
let is_valid = {
let x = inner;
x <= 1u32
...
/// d#234
fn Decoder234(_input: &mut Parser<'_>, is_be: bool) -> Result<u16, ParseError> {
_input.skip_align(2)?;
PResult::Ok(match is_be {
true => {
let x = (_input.read_byte()?, _input.read_byte()?);
...
/// d#235
fn Decoder235(_input: &mut Parser<'_>) -> Result<u8, ParseError> {
let inner = _input.read_byte()?;
let is_valid = {
let x = inner;
x <= 2u8
...
/// d#244
fn Decoder244(_input: &mut Parser<'_>) -> Result<tar_ascii_string_opt0_nonempty, ParseError> {
let string = {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
...
/// d#248
fn Decoder248(_input: &mut Parser<'_>) -> Result<tiff_ifd_le, ParseError> {
let num_fields = {
let x = (_input.read_byte()?, _input.read_byte()?);
u16le(x)
};
...
/// d#251
fn Decoder251(_input: &mut Parser<'_>) -> Result<(u8, u8, u8, u8), ParseError> {
...
let tag = (Decoder267(_input))?;
let data = {
let sz = length as usize;
_input.start_slice(sz)?;
let ret = (Decoder268(_input))?;
_input.end_slice()?;
ret
};
let crc = {
...
/// d#258
fn Decoder258(_input: &mut Parser<'_>) -> Result<(u8, u8, u8, u8), ParseError> {
let arg0 = {
let b = _input.read_byte()?;
if b == 73 {
b
...
let literal_length_distance_alphabet_code_lengths = (Decoder264(_input, hlit, hdist, &code_length_alphabet_code_lengths))?;
...
/// d#264
fn Decoder264(_input: &mut Parser<'_>, hlit: u8, hdist: u8, code_length_alphabet_code_lengths: &[u8]) -> Result<Vec<deflate_dynamic_huffman_literal_length_distance_alphabet_code_lengths>, ParseError> {
...
0u8 => {
(Decoder266(_input, 0u8, 1u16))?
},

1u8 => {
(Decoder266(_input, 0u8, 2u16))?
},

2u8 => {
(Decoder266(_input, 0u8, 3u16))?
},

3u8 => {
(Decoder266(_input, 0u8, 4u16))?
},

4u8 => {
(Decoder266(_input, 1u8, 5u16))?
},

5u8 => {
(Decoder266(_input, 1u8, 7u16))?
},

6u8 => {
(Decoder266(_input, 2u8, 9u16))?
},

7u8 => {
(Decoder266(_input, 2u8, 13u16))?
},

8u8 => {
(Decoder266(_input, 3u8, 17u16))?
},

9u8 => {
(Decoder266(_input, 3u8, 25u16))?
},

10u8 => {
(Decoder266(_input, 4u8, 33u16))?
},

11u8 => {
(Decoder266(_input, 4u8, 49u16))?
},

12u8 => {
(Decoder266(_input, 5u8, 65u16))?
},

13u8 => {
(Decoder266(_input, 5u8, 97u16))?
},

14u8 => {
(Decoder266(_input, 6u8, 129u16))?
},

15u8 => {
(Decoder266(_input, 6u8, 193u16))?
},

16u8 => {
(Decoder266(_input, 7u8, 257u16))?
},

17u8 => {
(Decoder266(_input, 7u8, 385u16))?
},

18u8 => {
(Decoder266(_input, 8u8, 513u16))?
},

19u8 => {
(Decoder266(_input, 8u8, 769u16))?
},

20u8 => {
(Decoder266(_input, 9u8, 1025u16))?
},

21u8 => {
(Decoder266(_input, 9u8, 1537u16))?
},

22u8 => {
(Decoder266(_input, 10u8, 2049u16))?
},

23u8 => {
(Decoder266(_input, 10u8, 3073u16))?
},

24u8 => {
(Decoder266(_input, 11u8, 4097u16))?
},

25u8 => {
(Decoder266(_input, 11u8, 6145u16))?
},

26u8 => {
(Decoder266(_input, 12u8, 8193u16))?
},

27u8 => {
(Decoder266(_input, 12u8, 12289u16))?
},

28u8 => {
(Decoder266(_input, 13u8, 16385u16))?
},

29u8 => {
(Decoder266(_input, 13u8, 24577u16))?
},
...
/// d#266
fn Decoder266(_input: &mut Parser<'_>, extra_bits: u8, start: u16) -> Result<deflate_distance_record0, ParseError> {
...
/// d#267
fn Decoder267(_input: &mut Parser<'_>) -> Result<(u8, u8, u8, u8), ParseError> {
let arg0 = {
let b = _input.read_byte()?;
if b == 73 {
b
...
/// d#270
fn Decoder270(_input: &mut Parser<'_>) -> Result<Vec<gif_color_table_entry>, ParseError> {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
_input.open_peek_context();
...
let compressed_profile = (Decoder298(_input))?;
...
let compressed_text = {
let zlib = (Decoder287(_input))?;
let mut buf_parser = Parser::new(slice_all(&zlib.data.inflate));
let buf_input = &mut buf_parser;
(Decoder288(buf_input))?
};
...
/// d#287
fn Decoder287(_input: &mut Parser<'_>) -> Result<zlib_main, ParseError> {
let compression_method_flags = {
let inner = {
let _packed_bits = _input.read_byte()?;
let compression_info = _packed_bits >> 4u8 & 15u8;
...
/// d#288
fn Decoder288(_input: &mut Parser<'_>) -> Result<Vec<char>, ParseError> {
Decoder289(_input)
}
...
/// d#293
fn Decoder293(_input: &mut Parser<'_>) -> Result<zlib_main, ParseError> {
let compression_method_flags = {
let inner = {
let _packed_bits = _input.read_byte()?;
let compression_info = _packed_bits >> 4u8 & 15u8;
...
/// d#294
fn Decoder294(_input: &mut Parser<'_>) -> Result<Vec<char>, ParseError> {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
_input.open_peek_context();
...
/// d#297
fn Decoder297(_input: &mut Parser<'_>) -> Result<Vec<u8>, ParseError> {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let reps_left = {
_input.open_peek_context();
...
/// d#298
fn Decoder298(_input: &mut Parser<'_>) -> Result<zlib_main, ParseError> {
let compression_method_flags = {
let inner = {
let _packed_bits = _input.read_byte()?;
let compression_info = _packed_bits >> 4u8 & 15u8;
...
/// d#299
fn Decoder299(_input: &mut Parser<'_>) -> Result<(u8, u8, u8, u8), ParseError> {
let arg0 = {
let b = _input.read_byte()?;
if b == 73 {
b
...
/// d#302
fn Decoder302(_input: &mut Parser<'_>) -> Result<(u8, u8, u8, u8), ParseError> {
PResult::Ok((_input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?))
}

/// d#303
fn Decoder_mpeg4_ftyp_data(_input: &mut Parser<'_>) -> Result<mpeg4_ftyp_data, ParseError> {
let major_brand = (Decoder302(_input))?;
let minor_version = {
let x = (_input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?);
u32be(x)
};
...
if matching_ix == 0 {
let next_elem = (Decoder302(_input))?;
accum.push(next_elem)
} else {
break
}
...
let component_subtype = (Decoder302(_input))?;
...
if matching_ix == 0 {
let next_elem = (Decoder334(_input))?;
accum.push(next_elem)
} else {
break
}
...
/// d#334
fn Decoder334(_input: &mut Parser<'_>) -> Result<mpeg4_dref_data_data, ParseError> {
let size_field = {
let x = (_input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?);
u32be(x)
};
...
let handler_type = (Decoder302(_input))?;
let reserved = {
let arg0 = {
let x = (_input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?);
u32be(x)
...
let item_type = (Decoder302(_input))?;
let item_name = {
let chars = {
let mut accum = Vec::new();
while _input.remaining() > 0 {
...
if matching_ix == 0 {
let next_elem = (Decoder365(_input))?;
accum.push(next_elem)
} else {
break
}
...
/// d#365
fn Decoder365(_input: &mut Parser<'_>) -> Result<jpeg_scan, ParseError> {
let segments = {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
...
/// d#369
fn Decoder369(_input: &mut Parser<'_>) -> Result<u8, ParseError> {
let tree_index = {
_input.open_peek_context();
{
let ret = match _input.read_byte()? {
...
/// d#370
fn Decoder370(_input: &mut Parser<'_>) -> Result<jpeg_soi, ParseError> {
{
let b = _input.read_byte()?;
if b == 255 {
b
...
/// d#383
fn Decoder383(_input: &mut Parser<'_>) -> Result<jpeg_scan_data, ParseError> {
let scan_data = {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
...
/// d#385
fn Decoder385(_input: &mut Parser<'_>) -> Result<jpeg_sof0, ParseError> {
let marker = {
{
let b = _input.read_byte()?;
if b == 255 {
...
/// d#406
fn Decoder406(_input: &mut Parser<'_>) -> Result<jpeg_app2, ParseError> {
let marker = {
{
let b = _input.read_byte()?;
if b == 255 {
...
/// d#437
fn Decoder437(_input: &mut Parser<'_>) -> Result<Vec<u8>, ParseError> {
let chars = {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
...
/// d#443
fn Decoder443(_input: &mut Parser<'_>) -> Result<Vec<gzip_main>, ParseError> {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
_input.open_peek_context();
...
/// d#444
fn Decoder444(_input: &mut Parser<'_>) -> Result<tar_main, ParseError> {
let contents = {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
...
/// d#445
fn Decoder445(_input: &mut Parser<'_>) -> Result<Vec<u8>, ParseError> {
let chars = {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
...
/// d#446
fn Decoder446(_input: &mut Parser<'_>) -> Result<gzip_fcomment, ParseError> {
let comment = {
let chars = {
let mut accum = Vec::new();
while _input.remaining() > 0 {
...
let next_elem = (Decoder462(_input))?;
accum.push(next_elem)
};
Some(accum)
} else {
...
let terminator = (Decoder456(_input))?;
...
/// d#456
fn Decoder456(_input: &mut Parser<'_>) -> Result<u8, ParseError> {
let b = _input.read_byte()?;
PResult::Ok(if b == 0 {
b
} else {
...
/// d#462
fn Decoder462(_input: &mut Parser<'_>) -> Result<gif_color_table_entry, ParseError> {
let r = _input.read_byte()?;
let g = _input.read_byte()?;
let b = _input.read_byte()?;
PResult::Ok(gif_color_table_entry { r, g, b })
...
/// d#468
fn Decoder468(_input: &mut Parser<'_>) -> Result<u32, ParseError> {
let tuple_var = {
let arg0 = {
let mut accum = Vec::new();
while _input.remaining() > 0 {
...
/// d#470
fn Decoder470(_input: &mut Parser<'_>) -> Result<jpeg_sof_image_component, ParseError> {
let id = _input.read_byte()?;
let sampling_factor = (Decoder471(_input))?;
let quantization_table_id = {
let b = _input.read_byte()?;
if b == 0 {
b
...
/// d#471
fn Decoder471(_input: &mut Parser<'_>) -> Result<jpeg_dhp_image_component_sampling_factor, ParseError> {
let _packed_bits = _input.read_byte()?;
let horizontal = _packed_bits >> 4u8 & 15u8;
let vertical = _packed_bits & 15u8;
PResult::Ok(jpeg_dhp_image_component_sampling_factor { horizontal, vertical })
...
/// d#472
fn Decoder472(_input: &mut Parser<'_>) -> Result<jpeg_sof_data, ParseError> {
...
let mut accum = Vec::new();
for _ in 0..num_image_components {
let next_elem = (Decoder473(_input))?;
accum.push(next_elem)
};
accum
};
...
/// d#473
fn Decoder473(_input: &mut Parser<'_>) -> Result<jpeg_sof_image_component, ParseError> {
let id = _input.read_byte()?;
let sampling_factor = (Decoder471(_input))?;
let quantization_table_id = {
let b = _input.read_byte()?;
...
/// d#475
fn Decoder475(_input: &mut Parser<'_>) -> Result<jpeg_app2, ParseError> {
let marker = {
{
let b = _input.read_byte()?;
if b == 255 {
...
/// d#476
fn Decoder476(_input: &mut Parser<'_>) -> Result<jpeg_sof0, ParseError> {
let marker = {
{
let b = _input.read_byte()?;
if b == 255 {
...
/// d#477
fn Decoder477(_input: &mut Parser<'_>) -> Result<jpeg_sof_data, ParseError> {
let sample_precision = _input.read_byte()?;
let num_lines = {
let x = (_input.read_byte()?, _input.read_byte()?);
u16be(x)
...
/// d#479
fn Decoder479(_input: &mut Parser<'_>) -> Result<jpeg_exp_data, ParseError> {
let expand_horizontal_vertical = {
let inner = {
let _packed_bits = _input.read_byte()?;
let expand_horizontal = _packed_bits >> 4u8 & 15u8;
