...
let r#where = ((|| PResult::Ok((Decoder80(_input))?))())?;
...
let next_elem = (Decoder309(_input))?;
accum.push(next_elem);
}
}
PResult::Ok(accum)
...
let gzip_raw = (Decoder286(_input))?;
let mut accum = Vec::new();
...
let eoi = ((|| PResult::Ok((Decoder208(_input))?))())?;
...
let signature = ((|| PResult::Ok((Decoder137(_input))?))())?;
...
let length = ((|| PResult::Ok((Decoder108(_input))?))())?;
let data = ((|| PResult::Ok({
...
tiff_main_byte_order::le(..) => {
let num_fields = ((|| PResult::Ok((Decoder120(_input))?))())?;
let fields = ((|| PResult::Ok({
let mut accum = Vec::new();
for _ in 0..num_fields {
accum.push({
let tag = ((|| PResult::Ok((Decoder120(_input))?))())?;
let r#type = ((|| PResult::Ok((Decoder120(_input))?))())?;
let length = ((|| PResult::Ok((Decoder108(_input))?))())?;
let offset_or_data = ((|| PResult::Ok((Decoder108(_input))?))())?;
tiff_main_ifd_fields { tag, r#type, length, offset_or_data }
});
}
accum
}))())?;
let next_ifd_offset = ((|| PResult::Ok((Decoder108(_input))?))())?;
...
let _is_advance = _input.advance_or_seek(tgt_offset)?;
let ret = ((|| PResult::Ok((Decoder95(_input, header.ident.data.clone() == 2u8, header.ident.class.clone(), header.phnum.clone()))?))())?;
_input.close_peek_context()?;
Some(ret)
} else {
None
...
let _is_advance = _input.advance_or_seek(tgt_offset)?;
let ret = ((|| PResult::Ok((Decoder96(_input, header.ident.data.clone() == 2u8, header.ident.class.clone(), header.shnum.clone()))?))())?;
_input.close_peek_context()?;
Some(ret)
} else {
None
...
let _is_advance = _input.advance_or_seek(tgt_offset)?;
let ret = ((|| PResult::Ok((Decoder97(_input, shdr.r#type.clone(), match shdr.size.clone() {
...
let created = ((|| PResult::Ok((Decoder79(_input))?))())?;
let modified = ((|| PResult::Ok((Decoder79(_input))?))())?;
...
opentype_gpos_table_lookup_list_link_lookups_link_subtables_link::MarkMarkPos(inner)
},
...
let value_record = ((|| PResult::Ok((Decoder69(_input, table_start.clone(), value_format.clone()))?))())?;
...
accum.push((Decoder69(_input, table_start.clone(), value_format.clone()))?);
}
accum
}))())?;
...
Some((Decoder69(_input, table_start.clone(), value_format2.clone()))?)
} else {
None
}))())?;
...
accum.push({
let value_record1 = ((|| PResult::Ok(if value_format1.x_placement.clone() || value_format1.y_placement.clone() || value_format1.x_advance.clone() || value_format1.y_advance.clone() || value_format1.x_placement_device.clone() || value_format1.y_placement_device.clone() || value_format1.x_advance_device.clone() || value_format1.y_advance_device.clone() {
Some((Decoder70(_input, table_start.clone(), value_format1.clone()))?)
} else {
None
}))())?;
let value_record2 = ((|| PResult::Ok(if value_format2.x_placement.clone() || value_format2.y_placement.clone() || value_format2.x_advance.clone() || value_format2.y_advance.clone() || value_format2.x_placement_device.clone() || value_format2.y_placement_device.clone() || value_format2.x_advance_device.clone() || value_format2.y_advance_device.clone() {
Some((Decoder71(_input, table_start.clone(), value_format2.clone()))?)
} else {
None
}))())?;
...
fn Decoder71<'input>(_input: &mut Parser<'input>, table_start: u32, flags: opentype_common_value_format_flags) -> Result<opentype_common_value_record, ParseError> {
let x_placement = ((|| PResult::Ok(if flags.x_placement.clone() {
Some((Decoder23(_input))?)
} else {
None
...
fn Decoder80<'input>(_input: &mut Parser<'input>) -> Result<u64, ParseError> {
let inner = {
let field0 = ((|| PResult::Ok((Decoder24(_input))?))())?;
let field1 = ((|| PResult::Ok((Decoder24(_input))?))())?;
let field2 = ((|| PResult::Ok((Decoder24(_input))?))())?;
...
13u16 => {
let inner = (Decoder90(_input, _platform.clone()))?;
...
fn Decoder90<'input>(_input: &mut Parser<'input>, _platform: u16) -> Result<opentype_cmap_subtable_format13, ParseError> {
let length = {
_input.open_peek_context();
let ret = ((|| PResult::Ok({
let _ = {
...
let r#type = ((|| PResult::Ok((Decoder116(_input, ident.data.clone() == 2u8))?))())?;
let machine = ((|| PResult::Ok((Decoder117(_input, ident.data.clone() == 2u8))?))())?;
let version = ((|| PResult::Ok((Decoder118(_input, ident.data.clone() == 2u8))?))())?;
...
let flags = ((|| PResult::Ok((Decoder99(_input, ident.data.clone() == 2u8))?))())?;
let ehsize = ((|| PResult::Ok((Decoder119(_input, ident.data.clone() == 2u8))?))())?;
let phentsize = ((|| PResult::Ok((Decoder119(_input, ident.data.clone() == 2u8))?))())?;
let phnum = ((|| PResult::Ok((Decoder119(_input, ident.data.clone() == 2u8))?))())?;
let shentsize = ((|| PResult::Ok((Decoder119(_input, ident.data.clone() == 2u8))?))())?;
let shnum = ((|| PResult::Ok((Decoder119(_input, ident.data.clone() == 2u8))?))())?;
let shstrndx = ((|| PResult::Ok((Decoder119(_input, ident.data.clone() == 2u8))?))())?;
...
fn Decoder95<'input>(_input: &mut Parser<'input>, is_be: bool, class: u8, phnum: u16) -> Result<Vec<elf_phdr_table>, ParseError> {
let mut accum = Vec::new();
for _ in 0..phnum {
...
fn Decoder96<'input>(_input: &mut Parser<'input>, is_be: bool, class: u8, shnum: u16) -> Result<Vec<elf_shdr_table>, ParseError> {
let mut accum = Vec::new();
for _ in 0..shnum {
...
fn Decoder97<'input>(_input: &mut Parser<'input>, r#type: u32, size: u64) -> Result<Vec<u8>, ParseError> {
...
let name = ((|| PResult::Ok((Decoder99(_input, is_be.clone()))?))())?;
let r#type = ((|| PResult::Ok((Decoder100(_input, is_be.clone()))?))())?;
...
let link = ((|| PResult::Ok((Decoder99(_input, is_be.clone()))?))())?;
let info = ((|| PResult::Ok((Decoder104(_input, is_be.clone()))?))())?;
...
fn Decoder100<'input>(_input: &mut Parser<'input>, is_be: bool) -> Result<u32, ParseError> {
...
2u8 => {
let inner = (Decoder106(_input, is_be.clone()))?;
...
PResult::Ok((Decoder99(_input, is_be.clone()))?)
}

fn Decoder105<'input>(_input: &mut Parser<'input>, is_be: bool) -> Result<u32, ParseError> {
let _ = _input.skip_align(4)?;
PResult::Ok(match is_be {
true => {
(Decoder20(_input))?
...
fn Decoder106<'input>(_input: &mut Parser<'input>, is_be: bool) -> Result<u64, ParseError> {
...
fn Decoder107<'input>(_input: &mut Parser<'input>) -> Result<u64, ParseError> {
let inner = {
let field0 = ((|| PResult::Ok((Decoder24(_input))?))())?;
let field1 = ((|| PResult::Ok((Decoder24(_input))?))())?;
let field2 = ((|| PResult::Ok((Decoder24(_input))?))())?;
...
fn Decoder108<'input>(_input: &mut Parser<'input>) -> Result<u32, ParseError> {
let inner = {
let field0 = ((|| PResult::Ok((Decoder24(_input))?))())?;
let field1 = ((|| PResult::Ok((Decoder24(_input))?))())?;
let field2 = ((|| PResult::Ok((Decoder24(_input))?))())?;
...
fn Decoder109<'input>(_input: &mut Parser<'input>, is_be: bool) -> Result<u32, ParseError> {
let _ = _input.skip_align(4)?;
PResult::Ok(match is_be {
true => {
(Decoder20(_input))?
...
fn Decoder111<'input>(_input: &mut Parser<'input>, is_be: bool) -> Result<u64, ParseError> {
let _ = _input.skip_align(8)?;
PResult::Ok(match is_be {
true => {
(Decoder80(_input))?
...
let flags64 = ((|| PResult::Ok((Decoder113(_input, is_be.clone(), class.clone()))?))())?;
let offset = ((|| PResult::Ok((Decoder_elf_types_elf_off(_input, is_be.clone(), class.clone()))?))())?;
...
let flags32 = ((|| PResult::Ok((Decoder114(_input, is_be.clone(), class.clone()))?))())?;
...
Some((Decoder99(_input, is_be.clone()))?)
} else {
None
})
}

fn Decoder114<'input>(_input: &mut Parser<'input>, is_be: bool, class: u8) -> Result<Option<u32>, ParseError> {
...
let class = ((|| PResult::Ok((Decoder121(_input))?))())?;
let data = ((|| PResult::Ok((Decoder122(_input))?))())?;
let version = ((|| PResult::Ok((Decoder123(_input))?))())?;
let os_abi = ((|| PResult::Ok((Decoder124(_input))?))())?;
let abi_version = ((|| PResult::Ok((Decoder125(_input))?))())?;
...
let inner = (Decoder119(_input, is_be.clone()))?;
...
fn Decoder117<'input>(_input: &mut Parser<'input>, is_be: bool) -> Result<u16, ParseError> {
PResult::Ok((Decoder119(_input, is_be.clone()))?)
}
...
fn Decoder119<'input>(_input: &mut Parser<'input>, is_be: bool) -> Result<u16, ParseError> {
...
fn Decoder120<'input>(_input: &mut Parser<'input>) -> Result<u16, ParseError> {
let inner = {
let field0 = ((|| PResult::Ok((Decoder24(_input))?))())?;
let field1 = ((|| PResult::Ok((Decoder24(_input))?))())?;
(field0, field1)
...
fn Decoder125<'input>(_input: &mut Parser<'input>) -> Result<u8, ParseError> {
PResult::Ok((Decoder24(_input))?)
}
...
let __nul_or_wsp = ((|| PResult::Ok((Decoder130(_input))?))())?;
let __padding = ((|| PResult::Ok({
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
...
let __nil = ((|| PResult::Ok((Decoder130(_input))?))())?;
...
let typeflag = ((|| PResult::Ok((Decoder131(_input))?))())?;
...
fn Decoder131<'input>(_input: &mut Parser<'input>) -> Result<u8, ParseError> {
let b = _input.read_byte()?;
PResult::Ok(b)
}

fn Decoder132<'input>(_input: &mut Parser<'input>) -> Result<tar_ascii_string_opt0, ParseError> {
let string = ((|| PResult::Ok({
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
...
let tag = ((|| PResult::Ok((Decoder135(_input))?))())?;
let chunks = ((|| PResult::Ok({
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
...
fn Decoder135<'input>(_input: &mut Parser<'input>) -> Result<(u8, u8, u8, u8), ParseError> {
let field0 = ((|| PResult::Ok((Decoder131(_input))?))())?;
let field1 = ((|| PResult::Ok((Decoder131(_input))?))())?;
let field2 = ((|| PResult::Ok((Decoder131(_input))?))())?;
let field3 = ((|| PResult::Ok((Decoder131(_input))?))())?;
...
fn Decoder137<'input>(_input: &mut Parser<'input>) -> Result<(u8, u8, u8, u8, u8, u8, u8, u8), ParseError> {
let field0 = ((|| PResult::Ok({
let b = _input.read_byte()?;
if b == 137 {
b
...
let tag = ((|| PResult::Ok((Decoder184(_input))?))())?;
let data = ((|| PResult::Ok({
let sz = length as usize<>;
_input.start_slice(sz)?;
...
let tag = ((|| PResult::Ok((Decoder143(_input))?))())?;
let data = ((|| PResult::Ok({
let sz = length as usize<>;
_input.start_slice(sz)?;
...
fn Decoder143<'input>(_input: &mut Parser<'input>) -> Result<(u8, u8, u8, u8), ParseError> {
let field0 = ((|| PResult::Ok({
let b = _input.read_byte()?;
if b == 73 {
b
...
fn Decoder144<'input>(_input: &mut Parser<'input>) -> Result<(), ParseError> {
PResult::Ok(())
}
...
0u8 => {
(Decoder152(_input, 0u8, 1u16))?
},

1u8 => {
(Decoder152(_input, 0u8, 2u16))?
},

2u8 => {
(Decoder152(_input, 0u8, 3u16))?
},

3u8 => {
(Decoder152(_input, 0u8, 4u16))?
},

4u8 => {
(Decoder152(_input, 1u8, 5u16))?
},

5u8 => {
(Decoder152(_input, 1u8, 7u16))?
},

6u8 => {
(Decoder152(_input, 2u8, 9u16))?
},

7u8 => {
(Decoder152(_input, 2u8, 13u16))?
},

8u8 => {
(Decoder152(_input, 3u8, 17u16))?
},

9u8 => {
(Decoder152(_input, 3u8, 25u16))?
},

10u8 => {
(Decoder152(_input, 4u8, 33u16))?
},

11u8 => {
(Decoder152(_input, 4u8, 49u16))?
},

12u8 => {
(Decoder152(_input, 5u8, 65u16))?
},

13u8 => {
(Decoder152(_input, 5u8, 97u16))?
},

14u8 => {
(Decoder152(_input, 6u8, 129u16))?
},

15u8 => {
(Decoder152(_input, 6u8, 193u16))?
},

16u8 => {
(Decoder152(_input, 7u8, 257u16))?
},

17u8 => {
(Decoder152(_input, 7u8, 385u16))?
},

18u8 => {
(Decoder152(_input, 8u8, 513u16))?
},

19u8 => {
(Decoder152(_input, 8u8, 769u16))?
},

20u8 => {
(Decoder152(_input, 9u8, 1025u16))?
},

21u8 => {
(Decoder152(_input, 9u8, 1537u16))?
},

22u8 => {
(Decoder152(_input, 10u8, 2049u16))?
},

23u8 => {
(Decoder152(_input, 10u8, 3073u16))?
},

24u8 => {
(Decoder152(_input, 11u8, 4097u16))?
},

25u8 => {
(Decoder152(_input, 11u8, 6145u16))?
},

26u8 => {
(Decoder152(_input, 12u8, 8193u16))?
},

27u8 => {
(Decoder152(_input, 12u8, 12289u16))?
},

28u8 => {
(Decoder152(_input, 13u8, 16385u16))?
},

29u8 => {
(Decoder152(_input, 13u8, 24577u16))?
},

30u8..=31u8 => {
return Err(ParseError::FailToken(2508979988921372290u64));
},
...
fn Decoder152<'input>(_input: &mut Parser<'input>, extra_bits: u8, start: u16) -> Result<deflate_distance_record, ParseError> {
...
fn Decoder154<'input>(_input: &mut Parser<'input>) -> Result<Vec<u8>, ParseError> {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
_input.open_peek_context();
...
fn Decoder155<'input>(_input: &mut Parser<'input>) -> Result<u8, ParseError> {
let b = _input.read_byte()?;
...
fn Decoder156<'input>(_input: &mut Parser<'input>) -> Result<Vec<png_plte>, ParseError> {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
_input.open_peek_context();
...
let compressed_profile = ((|| PResult::Ok((Decoder183(_input))?))())?;
...
let inner = {
let field0 = ((|| PResult::Ok((Decoder177(_input))?))())?;
let field1 = ((|| PResult::Ok({
let b = _input.read_byte()?;
if b == 0 {
b
...
let inner = {
let field0 = ((|| PResult::Ok((Decoder179(_input))?))())?;
let field1 = ((|| PResult::Ok({
let b = _input.read_byte()?;
if b == 0 {
b
...
if matching_ix == 0 {
let next_elem = (Decoder131(_input))?;
accum.push(next_elem);
} else {
break
}
...
let keyword = ((|| PResult::Ok({
let inner = {
let field0 = ((|| PResult::Ok((Decoder172(_input))?))())?;
let field1 = ((|| PResult::Ok({
let b = _input.read_byte()?;
if b == 0 {
b
...
fn Decoder173<'input>(_input: &mut Parser<'input>) -> Result<zlib_main, ParseError> {
let compression_method_flags = ((|| PResult::Ok({
let inner = {
let inner = {
let b = _input.read_byte()?;
...
return Err(ParseError::FalsifiedWhere(2497564037439806374u64));
}
}))())?;
let flags = ((|| PResult::Ok({
let inner = {
...
PResult::Ok((Decoder175(_input))?)
}

fn Decoder175<'input>(_input: &mut Parser<'input>) -> Result<Vec<char>, ParseError> {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
_input.open_peek_context();
...
fn Decoder177<'input>(_input: &mut Parser<'input>) -> Result<Vec<u8>, ParseError> {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
_input.open_peek_context();
...
fn Decoder179<'input>(_input: &mut Parser<'input>) -> Result<Vec<char>, ParseError> {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
_input.open_peek_context();
...
fn Decoder180<'input>(_input: &mut Parser<'input>) -> Result<zlib_main, ParseError> {
let compression_method_flags = ((|| PResult::Ok({
let inner = {
let inner = {
let b = _input.read_byte()?;
...
return Err(ParseError::FalsifiedWhere(14428558544277089677u64));
}
}))())?;
let flags = ((|| PResult::Ok({
let inner = {
...
fn Decoder181<'input>(_input: &mut Parser<'input>) -> Result<Vec<char>, ParseError> {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
_input.open_peek_context();
...
fn Decoder183<'input>(_input: &mut Parser<'input>) -> Result<zlib_main, ParseError> {
let compression_method_flags = ((|| PResult::Ok({
let inner = {
let inner = {
let b = _input.read_byte()?;
...
fn Decoder184<'input>(_input: &mut Parser<'input>) -> Result<(u8, u8, u8, u8), ParseError> {
let field0 = ((|| PResult::Ok({
let b = _input.read_byte()?;
if b == 73 {
b
...
let r#type = ((|| PResult::Ok((Decoder187(_input))?))())?;
...
let inner = {
let major_brand = ((|| PResult::Ok((Decoder187(_input))?))())?;
...
fn Decoder187<'input>(_input: &mut Parser<'input>) -> Result<(u8, u8, u8, u8), ParseError> {
let field0 = ((|| PResult::Ok((Decoder131(_input))?))())?;
let field1 = ((|| PResult::Ok((Decoder131(_input))?))())?;
let field2 = ((|| PResult::Ok((Decoder131(_input))?))())?;
let field3 = ((|| PResult::Ok((Decoder131(_input))?))())?;
...
let handler_type = ((|| PResult::Ok((Decoder187(_input))?))())?;
...
let name = ((|| PResult::Ok((Decoder194(_input))?))())?;
...
1u8 => {
let inner = {
let creation_time = ((|| PResult::Ok((Decoder80(_input))?))())?;
let modification_time = ((|| PResult::Ok((Decoder80(_input))?))())?;
let timescale = ((|| PResult::Ok((Decoder20(_input))?))())?;
let duration = ((|| PResult::Ok((Decoder80(_input))?))())?;
...
let component_subtype = ((|| PResult::Ok((Decoder187(_input))?))())?;
...
let component_name = ((|| PResult::Ok((Decoder194(_input))?))())?;
...
let item_name = ((|| PResult::Ok((Decoder201(_input))?))())?;
let content_type = ((|| PResult::Ok((Decoder202(_input))?))())?;
let content_encoding = ((|| PResult::Ok((Decoder203(_input))?))())?;
...
let item_protection_index = ((|| PResult::Ok((Decoder23(_input))?))())?;
let item_type = ((|| PResult::Ok((Decoder187(_input))?))())?;
let item_name = ((|| PResult::Ok((Decoder204(_input))?))())?;
let extra_fields = ((|| PResult::Ok(match item_type {
(109u8, 105u8, 109u8, 101u8) => {
let inner = {
let content_type = ((|| PResult::Ok((Decoder205(_input))?))())?;
...
let inner = {
let item_uri_type = ((|| PResult::Ok((Decoder205(_input))?))())?;
...
if matching_ix == 0 {
let next_elem = (Decoder215(_input))?;
accum.push(next_elem);
} else {
break
}
...
let data = ((|| PResult::Ok((Decoder230(_input))?))())?;
...
fn Decoder215<'input>(_input: &mut Parser<'input>) -> Result<jpeg_scan, ParseError> {
let segments = ((|| PResult::Ok({
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
...
fn Decoder218<'input>(_input: &mut Parser<'input>) -> Result<u8, ParseError> {
let tree_index = {
_input.open_peek_context();
let b = _input.read_byte()?;
{
...
return Err(ParseError::FalsifiedWhere(8306706226429158303u64));
}
}))())?;
PResult::Ok(jpeg_dnl_data { num_lines })
}

fn Decoder230<'input>(_input: &mut Parser<'input>) -> Result<jpeg_scan_data, ParseError> {
let scan_data = ((|| PResult::Ok({
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
...
return Err(ParseError::FalsifiedWhere(13675295148592556047u64));
}
}))())?;
...
let identifier = ((|| PResult::Ok((Decoder270(_input))?))())?;
...
let identifier = ((|| PResult::Ok((Decoder274(_input))?))())?;
let data = ((|| PResult::Ok(match identifier.string.as_slice() {
[74u8, 70u8, 73u8, 70u8] => {
...
let timestamp = ((|| PResult::Ok((Decoder108(_input))?))())?;
...
let xlen = ((|| PResult::Ok((Decoder120(_input))?))())?;
...
fn Decoder284<'input>(_input: &mut Parser<'input>) -> Result<base_asciiz_string, ParseError> {
let string = ((|| PResult::Ok({
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
...
let si1 = ((|| PResult::Ok((Decoder131(_input))?))())?;
let si2 = ((|| PResult::Ok((Decoder131(_input))?))())?;
let len = ((|| PResult::Ok((Decoder120(_input))?))())?;
let data = ((|| PResult::Ok({
let mut accum = Vec::new();
for _ in 0..len {
accum.push((Decoder24(_input))?);
...
fn Decoder286<'input>(_input: &mut Parser<'input>) -> Result<Vec<gzip_main>, ParseError> {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
_input.open_peek_context();
...
fn Decoder287<'input>(_input: &mut Parser<'input>) -> Result<base_asciiz_string, ParseError> {
PResult::Ok((Decoder290(_input))?)
}

fn Decoder288<'input>(_input: &mut Parser<'input>) -> Result<gzip_fcomment, ParseError> {
let comment = ((|| PResult::Ok((Decoder289(_input))?))())?;
PResult::Ok(gzip_fcomment { comment })
}
...
let terminator = ((|| PResult::Ok((Decoder300(_input))?))())?;
...
fn Decoder300<'input>(_input: &mut Parser<'input>) -> Result<u8, ParseError> {
let b = _input.read_byte()?;
PResult::Ok(if b == 0 {
b
} else {
...
let delay_time = ((|| PResult::Ok((Decoder120(_input))?))())?;
...
let text_grid_left_position = ((|| PResult::Ok((Decoder120(_input))?))())?;
let text_grid_top_position = ((|| PResult::Ok((Decoder120(_input))?))())?;
let text_grid_width = ((|| PResult::Ok((Decoder120(_input))?))())?;
let text_grid_height = ((|| PResult::Ok((Decoder120(_input))?))())?;
...
let image_left_position = ((|| PResult::Ok((Decoder120(_input))?))())?;
let image_top_position = ((|| PResult::Ok((Decoder120(_input))?))())?;
let image_width = ((|| PResult::Ok((Decoder120(_input))?))())?;
let image_height = ((|| PResult::Ok((Decoder120(_input))?))())?;
let flags = ((|| PResult::Ok({
let inner = {
let b = _input.read_byte()?;
b
...
fn Decoder306<'input>(_input: &mut Parser<'input>) -> Result<png_plte, ParseError> {
let r = ((|| PResult::Ok((Decoder24(_input))?))())?;
let g = ((|| PResult::Ok((Decoder24(_input))?))())?;
let b = ((|| PResult::Ok((Decoder24(_input))?))())?;
PResult::Ok(png_plte { r, g, b })
...
let screen_width = ((|| PResult::Ok((Decoder120(_input))?))())?;
let screen_height = ((|| PResult::Ok((Decoder120(_input))?))())?;
let flags = ((|| PResult::Ok({
let inner = {
let b = _input.read_byte()?;
b
...
fn Decoder309<'input>(_input: &mut Parser<'input>) -> Result<u32, ParseError> {
let inner = {
let field0 = ((|| PResult::Ok({
let mut accum = Vec::new();
while _input.remaining() > 0 {
