...
value_name_id: u16,
value: opentype_post_table_italic_angle
}
...
flags: opentype_stat_table_offset_to_axis_value_offsets_link_axis_value_offsets_link_data_Format1_flags,
value_name_id: u16,
nominal_value: opentype_post_table_italic_angle,
range_min_value: opentype_post_table_italic_angle,
range_max_value: opentype_post_table_italic_angle
}
...
value_name_id: u16,
value: opentype_post_table_italic_angle,
linked_value: opentype_post_table_italic_angle
}
...
let r#where = ((|| PResult::Ok((Decoder93(_input))?))())?;
...
let next_elem = (Decoder322(_input))?;
accum.push(next_elem);
}
}
PResult::Ok(accum)
...
let gzip_raw = (Decoder299(_input))?;
let mut accum = Vec::new();
...
let eoi = ((|| PResult::Ok((Decoder221(_input))?))())?;
...
let signature = ((|| PResult::Ok((Decoder150(_input))?))())?;
...
let length = ((|| PResult::Ok((Decoder121(_input))?))())?;
let data = ((|| PResult::Ok({
...
let length = ((|| PResult::Ok((Decoder121(_input))?))())?;
let offset_or_data = ((|| PResult::Ok((Decoder121(_input))?))())?;
tiff_main_ifd_fields { tag, r#type, length, offset_or_data }
});
}
accum
}))())?;
let next_ifd_offset = ((|| PResult::Ok((Decoder121(_input))?))())?;
...
let _is_advance = _input.advance_or_seek(tgt_offset)?;
let ret = ((|| PResult::Ok((Decoder108(_input, header.ident.data.clone() == 2u8, header.ident.class.clone(), header.phnum.clone()))?))())?;
_input.close_peek_context()?;
Some(ret)
} else {
None
...
let _is_advance = _input.advance_or_seek(tgt_offset)?;
let ret = ((|| PResult::Ok((Decoder109(_input, header.ident.data.clone() == 2u8, header.ident.class.clone(), header.shnum.clone()))?))())?;
_input.close_peek_context()?;
Some(ret)
} else {
None
...
let _is_advance = _input.advance_or_seek(tgt_offset)?;
let ret = ((|| PResult::Ok((Decoder110(_input, shdr.r#type.clone(), match shdr.size.clone() {
...
let table_id = ((|| PResult::Ok((Decoder44(_input))?))())?;
...
let __skip = ((|| PResult::Ok(_input.skip_remainder()))())?;
PResult::Ok(opentype_table_directory_table_links { cmap, head, hhea, maxp, hmtx, name, os2, post, cvt, fpgm, loca, glyf, prep, gasp, base, gdef, gpos, gsub, kern, stat, vhea, vmtx, __skip })
}
...
let created = ((|| PResult::Ok((Decoder92(_input))?))())?;
let modified = ((|| PResult::Ok((Decoder92(_input))?))())?;
...
let ach_vend_id = ((|| PResult::Ok((Decoder44(_input))?))())?;
...
accum.push({
let axis_tag = ((|| PResult::Ok((Decoder44(_input))?))())?;
...
fn Decoder44<'input>(_input: &mut Parser<'input>) -> Result<u32, ParseError> {
...
accum.push({
let script_tag = ((|| PResult::Ok((Decoder44(_input))?))())?;
...
accum.push({
let feature_tag = ((|| PResult::Ok((Decoder44(_input))?))())?;
...
accum.push({
let lang_sys_tag = ((|| PResult::Ok((Decoder44(_input))?))())?;
...
let value_record = ((|| PResult::Ok((Decoder76(_input, table_start.clone(), value_format.clone()))?))())?;
...
accum.push((Decoder76(_input, table_start.clone(), value_format.clone()))?);
}
accum
}))())?;
...
accum.push({
let value_record1 = ((|| PResult::Ok(if value_format1.x_placement.clone() || value_format1.y_placement.clone() || value_format1.x_advance.clone() || value_format1.y_advance.clone() || value_format1.x_placement_device.clone() || value_format1.y_placement_device.clone() || value_format1.x_advance_device.clone() || value_format1.y_advance_device.clone() {
Some((Decoder77(_input, table_start.clone(), value_format1.clone()))?)
} else {
None
}))())?;
let value_record2 = ((|| PResult::Ok(if value_format2.x_placement.clone() || value_format2.y_placement.clone() || value_format2.x_advance.clone() || value_format2.y_advance.clone() || value_format2.x_placement_device.clone() || value_format2.y_placement_device.clone() || value_format2.x_advance_device.clone() || value_format2.y_advance_device.clone() {
Some((Decoder78(_input, table_start.clone(), value_format2.clone()))?)
} else {
None
}))())?;
...
fn Decoder78<'input>(_input: &mut Parser<'input>, table_start: u32, flags: opentype_common_value_format_flags) -> Result<opentype_common_value_record, ParseError> {
let x_placement = ((|| PResult::Ok(if flags.x_placement.clone() {
Some((Decoder23(_input))?)
} else {
None
...
fn Decoder80<'input>(_input: &mut Parser<'input>) -> Result<(), ParseError> {
PResult::Ok(())
}
...
accum.push({
let base_script_tag = ((|| PResult::Ok((Decoder44(_input))?))())?;
...
accum.push({
let base_lang_sys_tag = ((|| PResult::Ok((Decoder44(_input))?))())?;
...
PResult::Ok((Decoder93(_input))?)
}

fn Decoder93<'input>(_input: &mut Parser<'input>) -> Result<u64, ParseError> {
let inner = {
let field0 = ((|| PResult::Ok((Decoder24(_input))?))())?;
let field1 = ((|| PResult::Ok((Decoder24(_input))?))())?;
let field2 = ((|| PResult::Ok((Decoder24(_input))?))())?;
...
13u16 => {
let inner = (Decoder103(_input, _platform.clone()))?;
...
fn Decoder103<'input>(_input: &mut Parser<'input>, _platform: u16) -> Result<opentype_cmap_subtable_format13, ParseError> {
let length = {
_input.open_peek_context();
let ret = ((|| PResult::Ok({
let _ = {
...
let r#type = ((|| PResult::Ok((Decoder129(_input, ident.data.clone() == 2u8))?))())?;
let machine = ((|| PResult::Ok((Decoder130(_input, ident.data.clone() == 2u8))?))())?;
let version = ((|| PResult::Ok((Decoder131(_input, ident.data.clone() == 2u8))?))())?;
...
let flags = ((|| PResult::Ok((Decoder112(_input, ident.data.clone() == 2u8))?))())?;
let ehsize = ((|| PResult::Ok((Decoder132(_input, ident.data.clone() == 2u8))?))())?;
let phentsize = ((|| PResult::Ok((Decoder132(_input, ident.data.clone() == 2u8))?))())?;
let phnum = ((|| PResult::Ok((Decoder132(_input, ident.data.clone() == 2u8))?))())?;
let shentsize = ((|| PResult::Ok((Decoder132(_input, ident.data.clone() == 2u8))?))())?;
let shnum = ((|| PResult::Ok((Decoder132(_input, ident.data.clone() == 2u8))?))())?;
let shstrndx = ((|| PResult::Ok((Decoder132(_input, ident.data.clone() == 2u8))?))())?;
...
fn Decoder108<'input>(_input: &mut Parser<'input>, is_be: bool, class: u8, phnum: u16) -> Result<Vec<elf_phdr_table>, ParseError> {
let mut accum = Vec::new();
for _ in 0..phnum {
...
fn Decoder109<'input>(_input: &mut Parser<'input>, is_be: bool, class: u8, shnum: u16) -> Result<Vec<elf_shdr_table>, ParseError> {
let mut accum = Vec::new();
for _ in 0..shnum {
...
fn Decoder110<'input>(_input: &mut Parser<'input>, r#type: u32, size: u64) -> Result<Vec<u8>, ParseError> {
...
let name = ((|| PResult::Ok((Decoder112(_input, is_be.clone()))?))())?;
let r#type = ((|| PResult::Ok((Decoder113(_input, is_be.clone()))?))())?;
...
let link = ((|| PResult::Ok((Decoder112(_input, is_be.clone()))?))())?;
let info = ((|| PResult::Ok((Decoder117(_input, is_be.clone()))?))())?;
...
let inner = (Decoder112(_input, is_be.clone()))?;
...
PResult::Ok((Decoder112(_input, is_be.clone()))?)
}
...
fn Decoder119<'input>(_input: &mut Parser<'input>, is_be: bool) -> Result<u64, ParseError> {
...
fn Decoder120<'input>(_input: &mut Parser<'input>) -> Result<u64, ParseError> {
let inner = {
let field0 = ((|| PResult::Ok((Decoder24(_input))?))())?;
let field1 = ((|| PResult::Ok((Decoder24(_input))?))())?;
let field2 = ((|| PResult::Ok((Decoder24(_input))?))())?;
...
fn Decoder121<'input>(_input: &mut Parser<'input>) -> Result<u32, ParseError> {
let inner = {
let field0 = ((|| PResult::Ok((Decoder24(_input))?))())?;
let field1 = ((|| PResult::Ok((Decoder24(_input))?))())?;
let field2 = ((|| PResult::Ok((Decoder24(_input))?))())?;
...
let flags64 = ((|| PResult::Ok((Decoder126(_input, is_be.clone(), class.clone()))?))())?;
let offset = ((|| PResult::Ok((Decoder_elf_types_elf_off(_input, is_be.clone(), class.clone()))?))())?;
...
let flags32 = ((|| PResult::Ok((Decoder127(_input, is_be.clone(), class.clone()))?))())?;
...
Some((Decoder112(_input, is_be.clone()))?)
} else {
None
})
}

fn Decoder127<'input>(_input: &mut Parser<'input>, is_be: bool, class: u8) -> Result<Option<u32>, ParseError> {
...
let class = ((|| PResult::Ok((Decoder134(_input))?))())?;
let data = ((|| PResult::Ok((Decoder135(_input))?))())?;
let version = ((|| PResult::Ok((Decoder136(_input))?))())?;
let os_abi = ((|| PResult::Ok((Decoder137(_input))?))())?;
let abi_version = ((|| PResult::Ok((Decoder138(_input))?))())?;
...
PResult::Ok((Decoder132(_input, is_be.clone()))?)
}

fn Decoder131<'input>(_input: &mut Parser<'input>, is_be: bool) -> Result<u32, ParseError> {
let inner = (Decoder112(_input, is_be.clone()))?;
...
let __nul_or_wsp = ((|| PResult::Ok((Decoder143(_input))?))())?;
let __padding = ((|| PResult::Ok({
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
...
let __nil = ((|| PResult::Ok((Decoder143(_input))?))())?;
...
let typeflag = ((|| PResult::Ok((Decoder144(_input))?))())?;
...
fn Decoder145<'input>(_input: &mut Parser<'input>) -> Result<tar_ascii_string_opt0, ParseError> {
let string = ((|| PResult::Ok({
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
...
let field1 = ((|| PResult::Ok((Decoder144(_input))?))())?;
let field2 = ((|| PResult::Ok((Decoder144(_input))?))())?;
let field3 = ((|| PResult::Ok((Decoder144(_input))?))())?;
...
fn Decoder150<'input>(_input: &mut Parser<'input>) -> Result<(u8, u8, u8, u8, u8, u8, u8, u8), ParseError> {
let field0 = ((|| PResult::Ok({
let b = _input.read_byte()?;
if b == 137 {
b
...
let tag = ((|| PResult::Ok((Decoder197(_input))?))())?;
let data = ((|| PResult::Ok({
let sz = length as usize<>;
_input.start_slice(sz)?;
...
let tag = ((|| PResult::Ok((Decoder166(_input))?))())?;
let data = ((|| PResult::Ok({
let sz = length as usize<>;
_input.start_slice(sz)?;
let ret = ((|| PResult::Ok((Decoder167(_input))?))())?;
_input.end_slice()?;
ret
}))())?;
let crc = ((|| PResult::Ok((Decoder20(_input))?))())?;
...
let tag = ((|| PResult::Ok((Decoder156(_input))?))())?;
let data = ((|| PResult::Ok({
let sz = length as usize<>;
_input.start_slice(sz)?;
...
fn Decoder156<'input>(_input: &mut Parser<'input>) -> Result<(u8, u8, u8, u8), ParseError> {
let field0 = ((|| PResult::Ok({
let b = _input.read_byte()?;
if b == 73 {
b
...
fn Decoder157<'input>(_input: &mut Parser<'input>) -> Result<(), ParseError> {
PResult::Ok(())
}
...
0u8 => {
(Decoder165(_input, 0u8, 1u16))?
},

1u8 => {
(Decoder165(_input, 0u8, 2u16))?
},

2u8 => {
(Decoder165(_input, 0u8, 3u16))?
},

3u8 => {
(Decoder165(_input, 0u8, 4u16))?
},

4u8 => {
(Decoder165(_input, 1u8, 5u16))?
},

5u8 => {
(Decoder165(_input, 1u8, 7u16))?
},

6u8 => {
(Decoder165(_input, 2u8, 9u16))?
},

7u8 => {
(Decoder165(_input, 2u8, 13u16))?
},

8u8 => {
(Decoder165(_input, 3u8, 17u16))?
},

9u8 => {
(Decoder165(_input, 3u8, 25u16))?
},

10u8 => {
(Decoder165(_input, 4u8, 33u16))?
},

11u8 => {
(Decoder165(_input, 4u8, 49u16))?
},

12u8 => {
(Decoder165(_input, 5u8, 65u16))?
},

13u8 => {
(Decoder165(_input, 5u8, 97u16))?
},

14u8 => {
(Decoder165(_input, 6u8, 129u16))?
},

15u8 => {
(Decoder165(_input, 6u8, 193u16))?
},

16u8 => {
(Decoder165(_input, 7u8, 257u16))?
},

17u8 => {
(Decoder165(_input, 7u8, 385u16))?
},

18u8 => {
(Decoder165(_input, 8u8, 513u16))?
},

19u8 => {
(Decoder165(_input, 8u8, 769u16))?
},

20u8 => {
(Decoder165(_input, 9u8, 1025u16))?
},

21u8 => {
(Decoder165(_input, 9u8, 1537u16))?
},

22u8 => {
(Decoder165(_input, 10u8, 2049u16))?
},

23u8 => {
(Decoder165(_input, 10u8, 3073u16))?
},

24u8 => {
(Decoder165(_input, 11u8, 4097u16))?
},

25u8 => {
(Decoder165(_input, 11u8, 6145u16))?
},

26u8 => {
(Decoder165(_input, 12u8, 8193u16))?
},

27u8 => {
(Decoder165(_input, 12u8, 12289u16))?
},

28u8 => {
(Decoder165(_input, 13u8, 16385u16))?
},

29u8 => {
(Decoder165(_input, 13u8, 24577u16))?
},

30u8..=31u8 => {
return Err(ParseError::FailToken(16299205781335471965u64));
},
...
fn Decoder165<'input>(_input: &mut Parser<'input>, extra_bits: u8, start: u16) -> Result<deflate_distance_record, ParseError> {
...
fn Decoder166<'input>(_input: &mut Parser<'input>) -> Result<(u8, u8, u8, u8), ParseError> {
let field0 = ((|| PResult::Ok({
let b = _input.read_byte()?;
if b == 73 {
b
...
fn Decoder168<'input>(_input: &mut Parser<'input>) -> Result<u8, ParseError> {
let b = _input.read_byte()?;
...
fn Decoder169<'input>(_input: &mut Parser<'input>) -> Result<Vec<png_plte>, ParseError> {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
_input.open_peek_context();
...
let compressed_profile = ((|| PResult::Ok((Decoder196(_input))?))())?;
...
let keyword = ((|| PResult::Ok({
let inner = {
let field0 = ((|| PResult::Ok((Decoder185(_input))?))())?;
let field1 = ((|| PResult::Ok({
let b = _input.read_byte()?;
if b == 0 {
b
...
fn Decoder185<'input>(_input: &mut Parser<'input>) -> Result<Vec<u8>, ParseError> {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
_input.open_peek_context();
...
fn Decoder186<'input>(_input: &mut Parser<'input>) -> Result<zlib_main, ParseError> {
let compression_method_flags = ((|| PResult::Ok({
let inner = {
let inner = {
let b = _input.read_byte()?;
...
return Err(ParseError::FalsifiedWhere(11930340298772268405u64));
}
}))())?;
let flags = ((|| PResult::Ok({
let inner = {
...
PResult::Ok((Decoder188(_input))?)
}

fn Decoder188<'input>(_input: &mut Parser<'input>) -> Result<Vec<char>, ParseError> {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
_input.open_peek_context();
...
fn Decoder193<'input>(_input: &mut Parser<'input>) -> Result<zlib_main, ParseError> {
let compression_method_flags = ((|| PResult::Ok({
let inner = {
let inner = {
let b = _input.read_byte()?;
...
return Err(ParseError::FalsifiedWhere(9819888267966403254u64));
}
}))())?;
let flags = ((|| PResult::Ok({
let inner = {
...
fn Decoder194<'input>(_input: &mut Parser<'input>) -> Result<Vec<char>, ParseError> {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
_input.open_peek_context();
...
return Err(ParseError::FalsifiedWhere(5364461768558038471u64));
}
}))())?;
let flags = ((|| PResult::Ok({
let inner = {
...
fn Decoder197<'input>(_input: &mut Parser<'input>) -> Result<(u8, u8, u8, u8), ParseError> {
let field0 = ((|| PResult::Ok({
let b = _input.read_byte()?;
if b == 73 {
b
...
let r#type = ((|| PResult::Ok((Decoder200(_input))?))())?;
...
let inner = {
let major_brand = ((|| PResult::Ok((Decoder200(_input))?))())?;
...
let handler_type = ((|| PResult::Ok((Decoder200(_input))?))())?;
...
let name = ((|| PResult::Ok((Decoder207(_input))?))())?;
...
1u8 => {
let inner = {
let creation_time = ((|| PResult::Ok((Decoder93(_input))?))())?;
let modification_time = ((|| PResult::Ok((Decoder93(_input))?))())?;
let timescale = ((|| PResult::Ok((Decoder20(_input))?))())?;
let duration = ((|| PResult::Ok((Decoder93(_input))?))())?;
...
let component_subtype = ((|| PResult::Ok((Decoder200(_input))?))())?;
...
let component_name = ((|| PResult::Ok((Decoder207(_input))?))())?;
...
let item_name = ((|| PResult::Ok((Decoder214(_input))?))())?;
let content_type = ((|| PResult::Ok((Decoder215(_input))?))())?;
let content_encoding = ((|| PResult::Ok((Decoder216(_input))?))())?;
...
let item_protection_index = ((|| PResult::Ok((Decoder23(_input))?))())?;
let item_type = ((|| PResult::Ok((Decoder200(_input))?))())?;
...
let inner = {
let item_uri_type = ((|| PResult::Ok((Decoder218(_input))?))())?;
...
let data = ((|| PResult::Ok((Decoder243(_input))?))())?;
...
fn Decoder228<'input>(_input: &mut Parser<'input>) -> Result<jpeg_scan, ParseError> {
let segments = ((|| PResult::Ok({
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
...
fn Decoder231<'input>(_input: &mut Parser<'input>) -> Result<u8, ParseError> {
let tree_index = {
_input.open_peek_context();
let b = _input.read_byte()?;
{
...
fn Decoder243<'input>(_input: &mut Parser<'input>) -> Result<jpeg_scan_data, ParseError> {
let scan_data = ((|| PResult::Ok({
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
...
return Err(ParseError::FalsifiedWhere(8385173961957899741u64));
}
}))())?;
let image_components = ((|| PResult::Ok({
let mut accum = Vec::new();
...
return Err(ParseError::FalsifiedWhere(8407356061009412694u64));
}
}))())?;
...
let identifier = ((|| PResult::Ok((Decoder283(_input))?))())?;
...
let identifier = ((|| PResult::Ok((Decoder287(_input))?))())?;
let data = ((|| PResult::Ok(match identifier.string.as_slice() {
[74u8, 70u8, 73u8, 70u8] => {
...
let timestamp = ((|| PResult::Ok((Decoder121(_input))?))())?;
...
let xlen = ((|| PResult::Ok((Decoder133(_input))?))())?;
...
let si1 = ((|| PResult::Ok((Decoder144(_input))?))())?;
let si2 = ((|| PResult::Ok((Decoder144(_input))?))())?;
let len = ((|| PResult::Ok((Decoder133(_input))?))())?;
let data = ((|| PResult::Ok({
let mut accum = Vec::new();
for _ in 0..len {
accum.push((Decoder24(_input))?);
...
fn Decoder299<'input>(_input: &mut Parser<'input>) -> Result<Vec<gzip_main>, ParseError> {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
_input.open_peek_context();
...
PResult::Ok((Decoder303(_input))?)
}

fn Decoder301<'input>(_input: &mut Parser<'input>) -> Result<gzip_fcomment, ParseError> {
...
let terminator = ((|| PResult::Ok((Decoder313(_input))?))())?;
...
fn Decoder313<'input>(_input: &mut Parser<'input>) -> Result<u8, ParseError> {
let b = _input.read_byte()?;
PResult::Ok(if b == 0 {
b
} else {
...
fn Decoder319<'input>(_input: &mut Parser<'input>) -> Result<png_plte, ParseError> {
let r = ((|| PResult::Ok((Decoder24(_input))?))())?;
let g = ((|| PResult::Ok((Decoder24(_input))?))())?;
let b = ((|| PResult::Ok((Decoder24(_input))?))())?;
PResult::Ok(png_plte { r, g, b })
...
fn Decoder322<'input>(_input: &mut Parser<'input>) -> Result<u32, ParseError> {
let inner = {
let field0 = ((|| PResult::Ok({
let mut accum = Vec::new();
while _input.remaining() > 0 {
