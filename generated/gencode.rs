...
/// expected size: 3
/// trait-unready: multiple (2) decoders exist (d#{397, 432})
#[derive(Debug, Copy, Clone)]
...
/// expected size: 24
/// trait-unready: multiple (2) decoders exist (d#{408, 416})
#[derive(Debug, Clone)]
...
/// expected size: 4
/// trait-unready: multiple (2) decoders exist (d#{235, 236})
#[derive(Debug, Copy, Clone)]
...
/// expected size: 1
/// trait-unready: multiple (10) decoders exist (d#{327, 329, 340, 341, 342, 343, 344, 345, 346, 347})
#[derive(Debug, Copy, Clone)]
pub struct jpeg_soi {
marker: u8
}
...
/// expected size: 56
/// trait-unready: multiple (3) decoders exist (d#{217, 218, 219})
#[derive(Debug, Clone)]
...
/// expected size: 32
/// trait-unready: multiple (16) decoders exist (d#{375, 376, 377, 378, 379, 380, 381, 382, 383, 384, 385, 386, 387, 388, 389, 445})
#[derive(Debug, Clone)]
...
/// expected size: 2
/// trait-unready: multiple (2) decoders exist (d#{439, 441})
#[derive(Debug, Copy, Clone)]
...
/// expected size: 4
/// trait-unready: multiple (3) decoders exist (d#{368, 440, 443})
#[derive(Debug, Copy, Clone)]
...
/// expected size: 32
/// trait-unready: multiple (3) decoders exist (d#{367, 442, 447})
#[derive(Debug, Clone)]
...
/// expected size: 40
/// trait-unready: multiple (14) decoders exist (d#{354, 355, 356, 357, 358, 359, 360, 361, 362, 363, 364, 365, 366, 446})
#[derive(Debug, Clone)]
...
/// expected size: 48
/// trait-unready: multiple (2) decoders exist (d#{337, 353})
#[derive(Debug, Clone)]
...
/// expected size: 40
/// trait-unready: multiple (2) decoders exist (d#{302, 304})
#[derive(Debug, Clone)]
...
/// expected size: 40
/// trait-unready: multiple (2) decoders exist (d#{176, 177})
#[derive(Debug, Clone)]
...
/// trait-orphaned: no decoder functions provided
#[derive(Debug, Copy, Clone)]
pub struct opentype_layout_value_record_x_placement_device {
offset: u16,
...
device: opentype_layout_value_record_x_placement_device
}
...
/// trait-orphaned: no decoder functions provided
#[derive(Debug, Copy, Clone)]
pub struct main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_base_item_var_store_offset__data_variation_region_list_offset__data_variation_regions_region_axes {
...
/// trait-orphaned: no decoder functions provided
#[derive(Debug, Clone)]
pub struct main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_base_item_var_store_offset__data_variation_region_list_offset__data_variation_regions {
region_axes: Vec<main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_base_item_var_store_offset__data_variation_region_list_offset__data_variation_regions_region_axes>
}

/// expected size: 32
/// trait-orphaned: no decoder functions provided
#[derive(Debug, Clone)]
pub struct opentype_common_item_variation_store_variation_region_list_offset__data {
axis_count: u16,
region_count: u16,
variation_regions: Vec<main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_base_item_var_store_offset__data_variation_region_list_offset__data_variation_regions>
}
...
offset: u32,
_data: std::marker::PhantomData<Option<opentype_common_item_variation_store_variation_region_list_offset__data>>
}

/// expected size: 4
/// trait-orphaned: no decoder functions provided
#[derive(Debug, Copy, Clone)]
pub struct main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_base_item_var_store_offset__data_item_variation_data_offsets__data_word_delta_count {
long_words: bool,
word_count: u16
}
...
/// trait-orphaned: no decoder functions provided
#[derive(Debug, Clone)]
pub struct main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_base_item_var_store_offset__data_item_variation_data_offsets__data_delta_sets_Delta16Sets {
...
/// trait-orphaned: no decoder functions provided
#[derive(Debug, Clone)]
pub struct main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_base_item_var_store_offset__data_item_variation_data_offsets__data_delta_sets_Delta32Sets {
...
/// trait-orphaned: no decoder functions provided
#[derive(Debug, Clone)]
pub enum main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_base_item_var_store_offset__data_item_variation_data_offsets__data_delta_sets { Delta16Sets(Vec<main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_base_item_var_store_offset__data_item_variation_data_offsets__data_delta_sets_Delta16Sets>), Delta32Sets(Vec<main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_base_item_var_store_offset__data_item_variation_data_offsets__data_delta_sets_Delta32Sets>) }

/// expected size: 64
/// trait-orphaned: no decoder functions provided
#[derive(Debug, Clone)]
pub struct opentype_common_item_variation_store_item_variation_data_offsets__data {
item_count: u16,
word_delta_count: main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_base_item_var_store_offset__data_item_variation_data_offsets__data_word_delta_count,
region_index_count: u16,
region_indices: Vec<u16>,
delta_sets: main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_base_item_var_store_offset__data_item_variation_data_offsets__data_delta_sets
}
...
offset: u32,
_data: std::marker::PhantomData<Option<opentype_common_item_variation_store_item_variation_data_offsets__data>>
}
...
/// trait-orphaned: no decoder functions provided
#[derive(Debug, Clone)]
pub struct opentype_gdef_attach_list_attach_point_offsets__data {
point_count: u16,
...
offset: u16,
_data: std::marker::PhantomData<Option<opentype_gdef_attach_list_attach_point_offsets__data>>
}
...
/// trait-orphaned: no decoder functions provided
#[derive(Debug, Copy, Clone)]
pub struct opentype_gdef_caret_value_data_Format3 {
coordinate: u16,
table: opentype_layout_value_record_x_placement_device
}

/// expected size: 6
/// trait-orphaned: no decoder functions provided
#[derive(Debug, Copy, Clone)]
pub enum opentype_gdef_caret_value_data { Format1(opentype_gdef_caret_value_data_Format1), Format2(opentype_gdef_caret_value_data_Format2), Format3(opentype_gdef_caret_value_data_Format3) }
...
data: opentype_gdef_caret_value_data
}
...
x_coordinate: u16,
y_coordinate: u16,
x_device: opentype_layout_value_record_x_placement_device,
y_device: opentype_layout_value_record_x_placement_device
}
...
/// expected size: 32
/// trait-unready: multiple (6) decoders exist (d#{135, 136, 139, 140, 143, 144})
#[derive(Debug, Copy, Clone)]
...
x_placement_device: Option<opentype_layout_value_record_x_placement_device>,
y_placement_device: Option<opentype_layout_value_record_x_placement_device>,
x_advance_device: Option<opentype_layout_value_record_x_placement_device>,
y_advance_device: Option<opentype_layout_value_record_x_placement_device>
}
...
/// trait-orphaned: no decoder functions provided
#[derive(Debug, Clone)]
pub struct opentype_layout_alternate_subst_alternate_sets__data {
glyph_count: u16,
...
offset: u16,
_data: std::marker::PhantomData<Option<opentype_layout_alternate_subst_alternate_sets__data>>
}

/// expected size: 56
/// trait-ready: unique decoder function (d#79)
#[derive(Debug, Clone)]
pub struct opentype_layout_alternate_subst<'input> {
table_scope: View<'input>,
subst_format: u16,
coverage: opentype_gdef_attach_list_coverage,
...
offset: u16,
_data: std::marker::PhantomData<Option<Vec<Vec<u16>>>>
}
...
/// trait-orphaned: no decoder functions provided
#[derive(Debug, Copy, Clone)]
pub struct main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_stat_design_axes__data_design_axes {
axis_tag: u32,
axis_name_id: u16,
axis_ordering: u16
}
...
/// trait-orphaned: no decoder functions provided
#[derive(Debug, Clone)]
pub struct opentype_stat_table_design_axes__data {
design_axes: Vec<main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_stat_design_axes__data_design_axes>
}
...
offset: u32,
_data: std::marker::PhantomData<Option<opentype_stat_table_design_axes__data>>
}

/// expected size: 2
/// trait-orphaned: no decoder functions provided
#[derive(Debug, Copy, Clone)]
pub struct main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_stat_axis_value_offsets__data_axis_value_offsets__data_data_Format1_flags {
...
/// trait-orphaned: no decoder functions provided
#[derive(Debug, Copy, Clone)]
pub struct main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_stat_axis_value_offsets__data_axis_value_offsets__data_data_Format1 {
axis_index: u16,
flags: main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_stat_axis_value_offsets__data_axis_value_offsets__data_data_Format1_flags,
value_name_id: u16,
...
/// trait-orphaned: no decoder functions provided
#[derive(Debug, Copy, Clone)]
pub struct main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_stat_axis_value_offsets__data_axis_value_offsets__data_data_Format2 {
axis_index: u16,
flags: main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_stat_axis_value_offsets__data_axis_value_offsets__data_data_Format1_flags,
value_name_id: u16,
...
/// trait-orphaned: no decoder functions provided
#[derive(Debug, Copy, Clone)]
pub struct main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_stat_axis_value_offsets__data_axis_value_offsets__data_data_Format3 {
axis_index: u16,
flags: main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_stat_axis_value_offsets__data_axis_value_offsets__data_data_Format1_flags,
value_name_id: u16,
value: opentype_head_table_font_revision,
...
/// trait-orphaned: no decoder functions provided
#[derive(Debug, Copy, Clone)]
pub struct main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_stat_axis_value_offsets__data_axis_value_offsets__data_data_Format4_axis_values {
axis_index: u16,
value: opentype_head_table_font_revision
}
...
/// trait-orphaned: no decoder functions provided
#[derive(Debug, Clone)]
pub struct main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_stat_axis_value_offsets__data_axis_value_offsets__data_data_Format4 {
axis_count: u16,
flags: main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_stat_axis_value_offsets__data_axis_value_offsets__data_data_Format1_flags,
value_name_id: u16,
axis_values: Vec<main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_stat_axis_value_offsets__data_axis_value_offsets__data_data_Format4_axis_values>
}

/// expected size: 40
/// trait-orphaned: no decoder functions provided
#[derive(Debug, Clone)]
pub enum main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_stat_axis_value_offsets__data_axis_value_offsets__data_data { Format1(main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_stat_axis_value_offsets__data_axis_value_offsets__data_data_Format1), Format2(main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_stat_axis_value_offsets__data_axis_value_offsets__data_data_Format2), Format3(main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_stat_axis_value_offsets__data_axis_value_offsets__data_data_Format3), Format4(main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_stat_axis_value_offsets__data_axis_value_offsets__data_data_Format4) }

/// expected size: 48
/// trait-orphaned: no decoder functions provided
#[derive(Debug, Clone)]
pub struct main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_stat_axis_value_offsets__data_axis_value_offsets__data {
format: u16,
data: main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_stat_axis_value_offsets__data_axis_value_offsets__data_data
}

/// expected size: 2
/// trait-orphaned: no decoder functions provided
#[derive(Debug, Copy, Clone)]
pub struct main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_stat_axis_value_offsets__data_axis_value_offsets {
offset: u16,
_data: std::marker::PhantomData<Option<main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_stat_axis_value_offsets__data_axis_value_offsets__data>>
}

/// expected size: 48
/// trait-orphaned: no decoder functions provided
#[derive(Debug, Clone)]
pub struct opentype_stat_table_axis_value_offsets__data<'input> {
array_scope: View<'input>,
axis_value_offsets: Vec<main_data_opentype_directory_TTCHeader_header_Version1_table_directories_link_table_links_stat_axis_value_offsets__data_axis_value_offsets>
}
...
offset: u32,
_data: std::marker::PhantomData<Option<opentype_stat_table_axis_value_offsets__data<'input>>>
}
...
/// expected size: 96
/// trait-unready: multiple (4) decoders exist (d#{226, 257, 263, 268})
#[derive(Debug, Clone)]
...
/// expected size: 24
/// trait-unready: multiple (3) decoders exist (d#{212, 214, 215})
#[derive(Debug, Clone)]
...
/// expected size: 24
/// trait-unready: multiple (2) decoders exist (d#{12, 414})
#[derive(Debug, Clone)]
pub struct tar_main {
...
/// expected size: 2
/// trait-unready: multiple (2) decoders exist (d#{444, 449})
#[derive(Debug, Copy, Clone)]
...
let next_elem = (Decoder438(_input))?;
accum.push(next_elem)
}
};
PResult::Ok(accum)
...
let _is_advance = _input.advance_or_seek(tgt_offset)?;
let ret = (Decoder182(_input, header.ident.data == 2u8, header.ident.class, header.phnum))?;
_input.close_peek_context()?;
Some(ret)
} else {
None
...
let _is_advance = _input.advance_or_seek(tgt_offset)?;
let ret = (Decoder183(_input, header.ident.data == 2u8, header.ident.class, header.shnum))?;
_input.close_peek_context()?;
Some(ret)
} else {
None
...
let _is_advance = _input.advance_or_seek(tgt_offset)?;
let ret = (Decoder184(_input, shdr.r#type, match shdr.size {
...
_ => {
return Err(ParseError::FailToken(17406968167054271466u64));
}
};
...
return Err(ParseError::FalsifiedWhere(5176232487486782188u64));
}
};
let major_version = {
let x = (_input.read_byte()?, _input.read_byte()?);
...
let created = (Decoder167(_input))?;
let modified = (Decoder167(_input))?;
let glyph_extents = {
let x_min = {
let x = (_input.read_byte()?, _input.read_byte()?);
u16be(x)
...
_ => {
return Err(ParseError::FailToken(7215050775822222282u64));
}
};
...
/// d#79
fn Decoder_opentype_layout_alternate_subst<'input>(_input: &mut Parser<'input>) -> Result<opentype_layout_alternate_subst<'input>, ParseError> {
let table_view = _input.view();
let table_scope = table_view;
let subst_format = {
let inner = {
...
let _data = std::marker::PhantomData;
opentype_layout_alternate_subst_alternate_sets { offset, _data }
};
accum.push(next_elem)
};
accum
};
PResult::Ok(opentype_layout_alternate_subst { table_scope, subst_format, coverage, alternate_set_count, alternate_sets })
}
...
let _data = std::marker::PhantomData;
opentype_layout_value_record_x_placement_device { offset, _data }
};
let y_device = {
let offset = {
let x = (_input.read_byte()?, _input.read_byte()?);
...
Some((Decoder136(_input, value_format2, table_view))?)
} else {
None
};
...
let _data = std::marker::PhantomData;
Some(opentype_layout_value_record_x_placement_device { offset, _data })
} else {
None
};
...
/// d#136
fn Decoder136<'input>(_input: &mut Parser<'input>, flags: opentype_layout_value_format_flags, table_view: View<'input>) -> Result<opentype_layout_value_record, ParseError> {
let x_placement = if flags.x_placement {
let x = (_input.read_byte()?, _input.read_byte()?);
Some(u16be(x))
} else {
...
let value_record1 = if value_format1.x_placement || value_format1.y_placement || value_format1.x_advance || value_format1.y_advance || value_format1.x_placement_device || value_format1.y_placement_device || value_format1.x_advance_device || value_format1.y_advance_device {
Some((Decoder139(_input, value_format1, set_view))?)
} else {
None
};
let value_record2 = if value_format2.x_placement || value_format2.y_placement || value_format2.x_advance || value_format2.y_advance || value_format2.x_placement_device || value_format2.y_placement_device || value_format2.x_advance_device || value_format2.y_advance_device {
Some((Decoder140(_input, value_format2, set_view))?)
} else {
None
};
...
/// d#139
fn Decoder139<'input>(_input: &mut Parser<'input>, flags: opentype_layout_value_format_flags, table_view: View<'input>) -> Result<opentype_layout_value_record, ParseError> {
let x_placement = if flags.x_placement {
let x = (_input.read_byte()?, _input.read_byte()?);
Some(u16be(x))
} else {
...
/// d#140
fn Decoder140<'input>(_input: &mut Parser<'input>, flags: opentype_layout_value_format_flags, table_view: View<'input>) -> Result<opentype_layout_value_record, ParseError> {
let x_placement = if flags.x_placement {
let x = (_input.read_byte()?, _input.read_byte()?);
Some(u16be(x))
} else {
...
let value_record = (Decoder144(_input, value_format, table_view))?;
...
let next_elem = (Decoder143(_input, value_format, table_view))?;
accum.push(next_elem)
};
accum
};
...
/// d#143
fn Decoder143<'input>(_input: &mut Parser<'input>, flags: opentype_layout_value_format_flags, table_view: View<'input>) -> Result<opentype_layout_value_record, ParseError> {
let x_placement = if flags.x_placement {
let x = (_input.read_byte()?, _input.read_byte()?);
Some(u16be(x))
} else {
...
let _data = std::marker::PhantomData;
opentype_common_item_variation_store_variation_region_list_offset { offset, _data }
};
...
let _data = std::marker::PhantomData;
opentype_common_item_variation_store_item_variation_data_offsets { offset, _data }
};
accum.push(next_elem)
};
accum
};
PResult::Ok(opentype_common_item_variation_store { table_scope, format, variation_region_list_offset, item_variation_data_count, item_variation_data_offsets })
}
...
opentype_gdef_caret_value_data_Format3 { coordinate, table }
};
...
PResult::Ok(opentype_gdef_caret_value { table_scope, caret_value_format, data })
}
...
n => {
try_sub!(65535u16, pred(n as u16), 13614619987783239962u64)
}
}
}
}
...
n => {
try_sub!(65535u16, pred(n as u16), 6949960292533894002u64)
}
}
}
}
...
/// d#167
fn Decoder167(_input: &mut Parser<'_>) -> Result<u64, ParseError> {
let x = (_input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?);
PResult::Ok(u64be(x))
}
...
13u16 => {
let inner = (Decoder177(_input, _platform))?;
...
/// d#177
fn Decoder177(_input: &mut Parser<'_>, _platform: u16) -> Result<opentype_cmap_subtable_format12, ParseError> {
let length = {
_input.open_peek_context();
let ret = ((|| {
{
...
let r#type = (Decoder201(_input, ident.data == 2u8))?;
let machine = (Decoder202(_input, ident.data == 2u8))?;
let version = (Decoder203(_input, ident.data == 2u8))?;
...
let flags = (Decoder186(_input, ident.data == 2u8))?;
let ehsize = (Decoder204(_input, ident.data == 2u8))?;
let phentsize = (Decoder204(_input, ident.data == 2u8))?;
let phnum = (Decoder204(_input, ident.data == 2u8))?;
let shentsize = (Decoder204(_input, ident.data == 2u8))?;
let shnum = (Decoder204(_input, ident.data == 2u8))?;
let shstrndx = (Decoder204(_input, ident.data == 2u8))?;
...
/// d#182
fn Decoder182(_input: &mut Parser<'_>, is_be: bool, class: u8, phnum: u16) -> Result<Vec<elf_phdr>, ParseError> {
let mut accum = Vec::new();
for _ in 0..phnum {
...
/// d#183
fn Decoder183(_input: &mut Parser<'_>, is_be: bool, class: u8, shnum: u16) -> Result<Vec<elf_shdr>, ParseError> {
let mut accum = Vec::new();
for _ in 0..shnum {
...
/// d#184
fn Decoder184(_input: &mut Parser<'_>, r#type: u32, size: u64) -> Result<Vec<u8>, ParseError> {
PResult::Ok({
let _ = r#type;
let mut accum = Vec::new();
for _ in 0..size {
...
let name = (Decoder186(_input, is_be))?;
let r#type = (Decoder187(_input, is_be))?;
...
let link = (Decoder186(_input, is_be))?;
let info = (Decoder191(_input, is_be))?;
...
/// d#186
fn Decoder186(_input: &mut Parser<'_>, is_be: bool) -> Result<u32, ParseError> {
_input.skip_align(4)?;
...
/// d#187
fn Decoder187(_input: &mut Parser<'_>, is_be: bool) -> Result<u32, ParseError> {
let inner = (Decoder186(_input, is_be))?;
let is_valid = {
let sh_type = inner;
...
2u8 => {
let inner = (Decoder196(_input, is_be))?;
...
PResult::Ok(match class {
1u8 => {
let inner = (Decoder194(_input, is_be))?;
elf_types_elf_addr::Addr32(inner)
},

2u8 => {
let inner = (Decoder195(_input, is_be))?;
...
PResult::Ok(match class {
1u8 => {
let inner = (Decoder192(_input, is_be))?;
elf_types_elf_off::Off32(inner)
},

2u8 => {
let inner = (Decoder193(_input, is_be))?;
...
/// d#191
fn Decoder191(_input: &mut Parser<'_>, is_be: bool) -> Result<u32, ParseError> {
Decoder186(_input, is_be)
}

/// d#192
fn Decoder192(_input: &mut Parser<'_>, is_be: bool) -> Result<u32, ParseError> {
_input.skip_align(4)?;
PResult::Ok(match is_be {
true => {
let x = (_input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?);
...
/// d#193
fn Decoder193(_input: &mut Parser<'_>, is_be: bool) -> Result<u64, ParseError> {
_input.skip_align(8)?;
PResult::Ok(match is_be {
true => {
let x = (_input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?);
...
/// d#194
fn Decoder194(_input: &mut Parser<'_>, is_be: bool) -> Result<u32, ParseError> {
_input.skip_align(4)?;
PResult::Ok(match is_be {
true => {
let x = (_input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?);
...
/// d#195
fn Decoder195(_input: &mut Parser<'_>, is_be: bool) -> Result<u64, ParseError> {
_input.skip_align(8)?;
PResult::Ok(match is_be {
true => {
let x = (_input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?);
...
/// d#196
fn Decoder196(_input: &mut Parser<'_>, is_be: bool) -> Result<u64, ParseError> {
_input.skip_align(8)?;
PResult::Ok(match is_be {
true => {
let x = (_input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?);
...
let r#type = (Decoder186(_input, is_be))?;
let flags64 = (Decoder198(_input, is_be, class))?;
let offset = (Decoder_elf_types_elf_off(_input, is_be, class))?;
...
let flags32 = (Decoder199(_input, is_be, class))?;
...
/// d#198
fn Decoder198(_input: &mut Parser<'_>, is_be: bool, class: u8) -> Result<Option<u32>, ParseError> {
PResult::Ok(if class == 2u8 {
Some((Decoder186(_input, is_be))?)
} else {
None
})
}
...
/// d#199
fn Decoder199(_input: &mut Parser<'_>, is_be: bool, class: u8) -> Result<Option<u32>, ParseError> {
...
let class = (Decoder205(_input))?;
let data = (Decoder206(_input))?;
let version = (Decoder207(_input))?;
let os_abi = (Decoder208(_input))?;
let abi_version = (Decoder209(_input))?;
{
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
...
/// d#201
fn Decoder201(_input: &mut Parser<'_>, is_be: bool) -> Result<u16, ParseError> {
...
/// d#202
fn Decoder202(_input: &mut Parser<'_>, is_be: bool) -> Result<u16, ParseError> {
Decoder204(_input, is_be)
}
...
/// d#204
fn Decoder204(_input: &mut Parser<'_>, is_be: bool) -> Result<u16, ParseError> {
_input.skip_align(2)?;
PResult::Ok(match is_be {
true => {
let x = (_input.read_byte()?, _input.read_byte()?);
...
/// d#205
fn Decoder205(_input: &mut Parser<'_>) -> Result<u8, ParseError> {
let inner = _input.read_byte()?;
let is_valid = {
let x = inner;
x <= 2u8
...
/// d#206
fn Decoder206(_input: &mut Parser<'_>) -> Result<u8, ParseError> {
let inner = _input.read_byte()?;
let is_valid = {
let x = inner;
x <= 2u8
...
/// d#207
fn Decoder207(_input: &mut Parser<'_>) -> Result<u8, ParseError> {
let inner = _input.read_byte()?;
let is_valid = {
let x = inner;
x <= 1u8
...
/// d#208
fn Decoder208(_input: &mut Parser<'_>) -> Result<u8, ParseError> {
_input.read_byte()
}

/// d#209
fn Decoder209(_input: &mut Parser<'_>) -> Result<u8, ParseError> {
_input.read_byte()
}
...
try_sub!(bit as u8, 48u8, 9976720501248819272u64)
};
let _o8 = {
let bit = {
let b = _input.read_byte()?;
...
try_sub!(bit as u8, 48u8, 3923207427992258326u64)
};
let _o6 = {
let bit = {
let b = _input.read_byte()?;
...
/// d#213
fn Decoder213(_input: &mut Parser<'_>) -> Result<u8, ParseError> {
let b = _input.read_byte()?;
...
/// d#214
fn Decoder214(_input: &mut Parser<'_>) -> Result<tar_ascii_string_opt0_nonempty, ParseError> {
let string = {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
...
/// d#215
fn Decoder215(_input: &mut Parser<'_>) -> Result<tar_ascii_string_opt0_nonempty, ParseError> {
let string = {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
...
/// d#218
fn Decoder218(_input: &mut Parser<'_>) -> Result<tiff_ifd_le, ParseError> {
let num_fields = {
let x = (_input.read_byte()?, _input.read_byte()?);
u16le(x)
};
...
/// d#219
fn Decoder219(_input: &mut Parser<'_>) -> Result<tiff_ifd_le, ParseError> {
let num_fields = {
let x = (_input.read_byte()?, _input.read_byte()?);
u16be(x)
};
...
/// d#221
fn Decoder221(_input: &mut Parser<'_>) -> Result<(u8, u8, u8, u8), ParseError> {
...
let tag = (Decoder237(_input))?;
let data = {
let sz = length as usize;
_input.start_slice(sz)?;
let ret = (Decoder238(_input))?;
_input.end_slice()?;
ret
};
let crc = {
...
/// d#228
fn Decoder228(_input: &mut Parser<'_>) -> Result<(u8, u8, u8, u8), ParseError> {
let arg0 = {
let b = _input.read_byte()?;
if b == 73 {
b
...
{
let ix = (try_sub!((buffer.len()) as u32, r.distance as u32, 8451221290566481190u64)) as usize;
...
let literal_length_distance_alphabet_code_lengths = (Decoder234(_input, hlit, hdist, &code_length_alphabet_code_lengths))?;
...
/// d#234
fn Decoder234(_input: &mut Parser<'_>, hlit: u8, hdist: u8, code_length_alphabet_code_lengths: &[u8]) -> Result<Vec<deflate_dynamic_huffman_literal_length_distance_alphabet_code_lengths>, ParseError> {
...
0u8 => {
(Decoder236(_input, 0u8, 1u16))?
},

1u8 => {
(Decoder236(_input, 0u8, 2u16))?
},

2u8 => {
(Decoder236(_input, 0u8, 3u16))?
},

3u8 => {
(Decoder236(_input, 0u8, 4u16))?
},

4u8 => {
(Decoder236(_input, 1u8, 5u16))?
},

5u8 => {
(Decoder236(_input, 1u8, 7u16))?
},

6u8 => {
(Decoder236(_input, 2u8, 9u16))?
},

7u8 => {
(Decoder236(_input, 2u8, 13u16))?
},

8u8 => {
(Decoder236(_input, 3u8, 17u16))?
},

9u8 => {
(Decoder236(_input, 3u8, 25u16))?
},

10u8 => {
(Decoder236(_input, 4u8, 33u16))?
},

11u8 => {
(Decoder236(_input, 4u8, 49u16))?
},

12u8 => {
(Decoder236(_input, 5u8, 65u16))?
},

13u8 => {
(Decoder236(_input, 5u8, 97u16))?
},

14u8 => {
(Decoder236(_input, 6u8, 129u16))?
},

15u8 => {
(Decoder236(_input, 6u8, 193u16))?
},

16u8 => {
(Decoder236(_input, 7u8, 257u16))?
},

17u8 => {
(Decoder236(_input, 7u8, 385u16))?
},

18u8 => {
(Decoder236(_input, 8u8, 513u16))?
},

19u8 => {
(Decoder236(_input, 8u8, 769u16))?
},

20u8 => {
(Decoder236(_input, 9u8, 1025u16))?
},

21u8 => {
(Decoder236(_input, 9u8, 1537u16))?
},

22u8 => {
(Decoder236(_input, 10u8, 2049u16))?
},

23u8 => {
(Decoder236(_input, 10u8, 3073u16))?
},

24u8 => {
(Decoder236(_input, 11u8, 4097u16))?
},

25u8 => {
(Decoder236(_input, 11u8, 6145u16))?
},

26u8 => {
(Decoder236(_input, 12u8, 8193u16))?
},

27u8 => {
(Decoder236(_input, 12u8, 12289u16))?
},

28u8 => {
(Decoder236(_input, 13u8, 16385u16))?
},

29u8 => {
(Decoder236(_input, 13u8, 24577u16))?
},

30u8..=31u8 => {
return Err(ParseError::FailToken(5599331855309773603u64));
},
...
/// d#236
fn Decoder236(_input: &mut Parser<'_>, extra_bits: u8, start: u16) -> Result<deflate_distance_record0, ParseError> {
...
/// d#237
fn Decoder237(_input: &mut Parser<'_>) -> Result<(u8, u8, u8, u8), ParseError> {
let arg0 = {
let b = _input.read_byte()?;
if b == 73 {
b
...
/// d#238
fn Decoder238(_input: &mut Parser<'_>) -> Result<Vec<u8>, ParseError> {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
_input.open_peek_context();
...
/// d#240
fn Decoder240(_input: &mut Parser<'_>) -> Result<Vec<gif_color_table_entry>, ParseError> {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
_input.open_peek_context();
...
let compressed_profile = (Decoder268(_input))?;
...
let compressed_text = {
let zlib = (Decoder257(_input))?;
let mut buf_parser = Parser::new(slice_all(&zlib.data.inflate));
let buf_input = &mut buf_parser;
(Decoder258(buf_input))?
};
...
/// d#255
fn Decoder255(_input: &mut Parser<'_>) -> Result<Vec<u8>, ParseError> {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let reps_left = {
_input.open_peek_context();
...
/// d#256
fn Decoder256(_input: &mut Parser<'_>) -> Result<Vec<u8>, ParseError> {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let reps_left = {
_input.open_peek_context();
...
/// d#257
fn Decoder257(_input: &mut Parser<'_>) -> Result<zlib_main, ParseError> {
let compression_method_flags = {
let inner = {
let _packed_bits = _input.read_byte()?;
let compression_info = _packed_bits >> 4u8 & 15u8;
...
return Err(ParseError::FalsifiedWhere(653172816195928449u64));
}
};
let flags = {
let _packed_bits = _input.read_byte()?;
...
/// d#258
fn Decoder258(_input: &mut Parser<'_>) -> Result<Vec<char>, ParseError> {
Decoder259(_input)
}

/// d#259
fn Decoder259(_input: &mut Parser<'_>) -> Result<Vec<char>, ParseError> {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
_input.open_peek_context();
...
/// d#262
fn Decoder262(_input: &mut Parser<'_>) -> Result<Vec<char>, ParseError> {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
_input.open_peek_context();
...
/// d#263
fn Decoder263(_input: &mut Parser<'_>) -> Result<zlib_main, ParseError> {
let compression_method_flags = {
let inner = {
let _packed_bits = _input.read_byte()?;
let compression_info = _packed_bits >> 4u8 & 15u8;
...
return Err(ParseError::FalsifiedWhere(7236895128762201498u64));
}
};
let flags = {
let _packed_bits = _input.read_byte()?;
...
/// d#264
fn Decoder264(_input: &mut Parser<'_>) -> Result<Vec<char>, ParseError> {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
_input.open_peek_context();
...
/// d#265
fn Decoder265(_input: &mut Parser<'_>) -> Result<Vec<char>, ParseError> {
Decoder266(_input)
}

/// d#266
fn Decoder266(_input: &mut Parser<'_>) -> Result<Vec<char>, ParseError> {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
_input.open_peek_context();
...
/// d#268
fn Decoder268(_input: &mut Parser<'_>) -> Result<zlib_main, ParseError> {
let compression_method_flags = {
let inner = {
let _packed_bits = _input.read_byte()?;
let compression_info = _packed_bits >> 4u8 & 15u8;
...
return Err(ParseError::FalsifiedWhere(14220958138979104104u64));
}
};
let flags = {
let _packed_bits = _input.read_byte()?;
...
/// d#269
fn Decoder269(_input: &mut Parser<'_>) -> Result<(u8, u8, u8, u8), ParseError> {
let arg0 = {
let b = _input.read_byte()?;
if b == 73 {
b
...
_ => {
(try_sub!(size_field, 8u32, 5576343694315527798u64)) as u64
}
};
let data = {
...
/// d#272
fn Decoder272(_input: &mut Parser<'_>) -> Result<(u8, u8, u8, u8), ParseError> {
PResult::Ok((_input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?))
}

/// d#273
fn Decoder_mpeg4_ftyp_data(_input: &mut Parser<'_>) -> Result<mpeg4_ftyp_data, ParseError> {
let major_brand = (Decoder272(_input))?;
let minor_version = {
let x = (_input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?);
u32be(x)
};
...
if matching_ix == 0 {
let next_elem = (Decoder272(_input))?;
accum.push(next_elem)
} else {
break
}
...
try_sub!(x, 16u64, 14832405617500840744u64)
},

_ => {
(try_sub!(size_field, 8u32, 4672672775256824980u64)) as u64
}
};
let data = {
let sz = size as usize;
...
_ => {
(try_sub!(size_field, 8u32, 98102193810481173u64)) as u64
}
};
let data = {
let sz = size as usize;
...
let component_subtype = (Decoder272(_input))?;
...
if matching_ix == 0 {
let next_elem = (Decoder304(_input))?;
accum.push(next_elem)
} else {
break
}
...
/// d#304
fn Decoder304(_input: &mut Parser<'_>) -> Result<mpeg4_dref_data_data, ParseError> {
let size_field = {
let x = (_input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?);
u32be(x)
};
...
let handler_type = (Decoder272(_input))?;
let reserved = {
let arg0 = {
let x = (_input.read_byte()?, _input.read_byte()?, _input.read_byte()?, _input.read_byte()?);
u32be(x)
...
let item_type = (Decoder272(_input))?;
let item_name = {
let chars = {
let mut accum = Vec::new();
while _input.remaining() > 0 {
...
/// d#329
fn Decoder329(_input: &mut Parser<'_>) -> Result<jpeg_soi, ParseError> {
{
let b = _input.read_byte()?;
if b == 255 {
b
...
let data = {
let sz = (try_sub!(length, 2u16, 8970999014112821604u64)) as usize;
_input.start_slice(sz)?;
...
/// d#335
fn Decoder335(_input: &mut Parser<'_>) -> Result<jpeg_scan, ParseError> {
let segments = {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
...
let data = {
let sz = (try_sub!(length, 2u16, 17089130856162883194u64)) as usize;
_input.start_slice(sz)?;
...
/// d#339
fn Decoder339(_input: &mut Parser<'_>) -> Result<u8, ParseError> {
let tree_index = {
_input.open_peek_context();
{
let ret = match _input.read_byte()? {
...
/// d#340
fn Decoder340(_input: &mut Parser<'_>) -> Result<jpeg_soi, ParseError> {
{
let b = _input.read_byte()?;
if b == 255 {
b
...
/// d#342
fn Decoder342(_input: &mut Parser<'_>) -> Result<jpeg_soi, ParseError> {
{
let b = _input.read_byte()?;
if b == 255 {
b
...
/// d#343
fn Decoder343(_input: &mut Parser<'_>) -> Result<jpeg_soi, ParseError> {
{
let b = _input.read_byte()?;
if b == 255 {
b
...
/// d#344
fn Decoder344(_input: &mut Parser<'_>) -> Result<jpeg_soi, ParseError> {
{
let b = _input.read_byte()?;
if b == 255 {
b
...
/// d#345
fn Decoder345(_input: &mut Parser<'_>) -> Result<jpeg_soi, ParseError> {
{
let b = _input.read_byte()?;
if b == 255 {
b
...
/// d#346
fn Decoder346(_input: &mut Parser<'_>) -> Result<jpeg_soi, ParseError> {
{
let b = _input.read_byte()?;
if b == 255 {
b
...
/// d#347
fn Decoder347(_input: &mut Parser<'_>) -> Result<jpeg_soi, ParseError> {
{
let b = _input.read_byte()?;
if b == 255 {
b
...
/// d#353
fn Decoder353(_input: &mut Parser<'_>) -> Result<jpeg_scan_data, ParseError> {
let scan_data = {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
...
let data = {
let sz = (try_sub!(length, 2u16, 13537165373980795457u64)) as usize;
_input.start_slice(sz)?;
...
/// d#355
fn Decoder355(_input: &mut Parser<'_>) -> Result<jpeg_sof0, ParseError> {
let marker = {
{
let b = _input.read_byte()?;
if b == 255 {
...
/// d#356
fn Decoder356(_input: &mut Parser<'_>) -> Result<jpeg_sof0, ParseError> {
let marker = {
{
let b = _input.read_byte()?;
if b == 255 {
...
/// d#357
fn Decoder357(_input: &mut Parser<'_>) -> Result<jpeg_sof0, ParseError> {
let marker = {
{
let b = _input.read_byte()?;
if b == 255 {
...
/// d#358
fn Decoder358(_input: &mut Parser<'_>) -> Result<jpeg_sof0, ParseError> {
let marker = {
{
let b = _input.read_byte()?;
if b == 255 {
...
/// d#359
fn Decoder359(_input: &mut Parser<'_>) -> Result<jpeg_sof0, ParseError> {
let marker = {
{
let b = _input.read_byte()?;
if b == 255 {
...
/// d#360
fn Decoder360(_input: &mut Parser<'_>) -> Result<jpeg_sof0, ParseError> {
let marker = {
{
let b = _input.read_byte()?;
if b == 255 {
...
/// d#361
fn Decoder361(_input: &mut Parser<'_>) -> Result<jpeg_sof0, ParseError> {
let marker = {
{
let b = _input.read_byte()?;
if b == 255 {
...
/// d#362
fn Decoder362(_input: &mut Parser<'_>) -> Result<jpeg_sof0, ParseError> {
let marker = {
{
let b = _input.read_byte()?;
if b == 255 {
...
/// d#363
fn Decoder363(_input: &mut Parser<'_>) -> Result<jpeg_sof0, ParseError> {
let marker = {
{
let b = _input.read_byte()?;
if b == 255 {
...
/// d#364
fn Decoder364(_input: &mut Parser<'_>) -> Result<jpeg_sof0, ParseError> {
let marker = {
{
let b = _input.read_byte()?;
if b == 255 {
...
/// d#365
fn Decoder365(_input: &mut Parser<'_>) -> Result<jpeg_sof0, ParseError> {
let marker = {
{
let b = _input.read_byte()?;
if b == 255 {
...
/// d#366
fn Decoder366(_input: &mut Parser<'_>) -> Result<jpeg_sof0, ParseError> {
let marker = {
{
let b = _input.read_byte()?;
if b == 255 {
...
/// d#376
fn Decoder376(_input: &mut Parser<'_>) -> Result<jpeg_app2, ParseError> {
let marker = {
{
let b = _input.read_byte()?;
if b == 255 {
...
/// d#377
fn Decoder377(_input: &mut Parser<'_>) -> Result<jpeg_app2, ParseError> {
let marker = {
{
let b = _input.read_byte()?;
if b == 255 {
...
/// d#378
fn Decoder378(_input: &mut Parser<'_>) -> Result<jpeg_app2, ParseError> {
let marker = {
{
let b = _input.read_byte()?;
if b == 255 {
...
/// d#379
fn Decoder379(_input: &mut Parser<'_>) -> Result<jpeg_app2, ParseError> {
let marker = {
{
let b = _input.read_byte()?;
if b == 255 {
...
/// d#380
fn Decoder380(_input: &mut Parser<'_>) -> Result<jpeg_app2, ParseError> {
let marker = {
{
let b = _input.read_byte()?;
if b == 255 {
...
/// d#381
fn Decoder381(_input: &mut Parser<'_>) -> Result<jpeg_app2, ParseError> {
let marker = {
{
let b = _input.read_byte()?;
if b == 255 {
...
/// d#382
fn Decoder382(_input: &mut Parser<'_>) -> Result<jpeg_app2, ParseError> {
let marker = {
{
let b = _input.read_byte()?;
if b == 255 {
...
/// d#383
fn Decoder383(_input: &mut Parser<'_>) -> Result<jpeg_app2, ParseError> {
let marker = {
{
let b = _input.read_byte()?;
if b == 255 {
...
/// d#384
fn Decoder384(_input: &mut Parser<'_>) -> Result<jpeg_app2, ParseError> {
let marker = {
{
let b = _input.read_byte()?;
if b == 255 {
...
/// d#385
fn Decoder385(_input: &mut Parser<'_>) -> Result<jpeg_app2, ParseError> {
let marker = {
{
let b = _input.read_byte()?;
if b == 255 {
...
/// d#386
fn Decoder386(_input: &mut Parser<'_>) -> Result<jpeg_app2, ParseError> {
let marker = {
{
let b = _input.read_byte()?;
if b == 255 {
...
/// d#387
fn Decoder387(_input: &mut Parser<'_>) -> Result<jpeg_app2, ParseError> {
let marker = {
{
let b = _input.read_byte()?;
if b == 255 {
...
/// d#407
fn Decoder407(_input: &mut Parser<'_>) -> Result<Vec<u8>, ParseError> {
let chars = {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
...
/// d#413
fn Decoder413(_input: &mut Parser<'_>) -> Result<Vec<gzip_main>, ParseError> {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
_input.open_peek_context();
...
let fname = if header.file_flags.fname {
Some((Decoder415(_input))?)
} else {
None
};
let fcomment = if header.file_flags.fcomment {
Some((Decoder416(_input))?)
} else {
None
};
let fhcrc = if header.file_flags.fhcrc {
...
/// d#414
fn Decoder414(_input: &mut Parser<'_>) -> Result<tar_main, ParseError> {
let contents = {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
...
/// d#415
fn Decoder415(_input: &mut Parser<'_>) -> Result<Vec<u8>, ParseError> {
let chars = {
let mut accum = Vec::new();
while _input.remaining() > 0 {
let matching_ix = {
...
/// d#416
fn Decoder416(_input: &mut Parser<'_>) -> Result<gzip_fcomment, ParseError> {
let comment = {
let chars = {
let mut accum = Vec::new();
while _input.remaining() > 0 {
...
let next_elem = (Decoder432(_input))?;
accum.push(next_elem)
};
Some(accum)
} else {
...
let terminator = (Decoder426(_input))?;
...
/// d#426
fn Decoder426(_input: &mut Parser<'_>) -> Result<u8, ParseError> {
let b = _input.read_byte()?;
PResult::Ok(if b == 0 {
b
} else {
...
/// d#432
fn Decoder432(_input: &mut Parser<'_>) -> Result<gif_color_table_entry, ParseError> {
let r = _input.read_byte()?;
let g = _input.read_byte()?;
let b = _input.read_byte()?;
PResult::Ok(gif_color_table_entry { r, g, b })
...
/// d#438
fn Decoder438(_input: &mut Parser<'_>) -> Result<u32, ParseError> {
let tuple_var = {
let arg0 = {
let mut accum = Vec::new();
while _input.remaining() > 0 {
...
/// d#440
fn Decoder440(_input: &mut Parser<'_>) -> Result<jpeg_sof_image_component, ParseError> {
let id = _input.read_byte()?;
let sampling_factor = (Decoder441(_input))?;
let quantization_table_id = {
let b = _input.read_byte()?;
if b == 0 {
b
...
/// d#441
fn Decoder441(_input: &mut Parser<'_>) -> Result<jpeg_dhp_image_component_sampling_factor, ParseError> {
let _packed_bits = _input.read_byte()?;
let horizontal = _packed_bits >> 4u8 & 15u8;
let vertical = _packed_bits & 15u8;
PResult::Ok(jpeg_dhp_image_component_sampling_factor { horizontal, vertical })
...
/// d#442
fn Decoder442(_input: &mut Parser<'_>) -> Result<jpeg_sof_data, ParseError> {
...
return Err(ParseError::FalsifiedWhere(4851501206534868925u64));
}
};
let num_image_components = {
let inner = _input.read_byte()?;
...
return Err(ParseError::FalsifiedWhere(4255480819017852249u64));
}
};
let image_components = {
let mut accum = Vec::new();
for _ in 0..num_image_components {
let next_elem = (Decoder443(_input))?;
accum.push(next_elem)
};
accum
};
...
/// d#443
fn Decoder443(_input: &mut Parser<'_>) -> Result<jpeg_sof_image_component, ParseError> {
let id = _input.read_byte()?;
let sampling_factor = (Decoder441(_input))?;
let quantization_table_id = {
let b = _input.read_byte()?;
...
/// d#446
fn Decoder446(_input: &mut Parser<'_>) -> Result<jpeg_sof0, ParseError> {
let marker = {
{
let b = _input.read_byte()?;
if b == 255 {
...
/// d#447
fn Decoder447(_input: &mut Parser<'_>) -> Result<jpeg_sof_data, ParseError> {
let sample_precision = _input.read_byte()?;
let num_lines = {
let x = (_input.read_byte()?, _input.read_byte()?);
u16be(x)
...
/// d#449
fn Decoder449(_input: &mut Parser<'_>) -> Result<jpeg_exp_data, ParseError> {
let expand_horizontal_vertical = {
let inner = {
let _packed_bits = _input.read_byte()?;
let expand_horizontal = _packed_bits >> 4u8 & 15u8;
