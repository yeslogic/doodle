...
use doodle_gencode::{
    ...
    opentype_gvar_table, opentype_head_table, opentype_hmtx_table, opentype_kern_table,
    opentype_loca_table, opentype_maxp_table, opentype_name_table, opentype_os2_table,
    opentype_post_table, opentype_stat_table, opentype_vhea_table,
};
