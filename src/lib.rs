...
impl VarType {
    ...
    fn var() -> VarType {
        VarType::Var(Rc::new(OnceCell::new()))
    }

    fn union(branches: Vec<(Label, VarType)>) -> VarType {
        VarType::Union(Rc::new(RefCell::new(VarUnion::Union(Rc::new(
